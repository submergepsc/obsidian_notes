...
- 状态: 已完成
- 目标: 查询并调整当前 Ctrl+r/fzf 使用的 Bash 历史来源，扩大记录数量并让多 pane/session 更及时同步。
- 阻塞: 无。
- 下一步: 新开 shell 或在现有 shell 执行 `source ~/.bashrc` 后生效。
- 更新时间: 2026-04-30 14:47:00 +0800
...
- 更新时间: 2026-04-30 14:43:26 +0800
- 工作目录: `/home/loviya`
- 来源指令: `查询一下当前ctrl+r实现的是什么功能,只能存储2000条记录,而且不是最新的两千条`
- 问题:
