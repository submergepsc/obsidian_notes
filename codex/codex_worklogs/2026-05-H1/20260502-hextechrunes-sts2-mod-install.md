...
# HextechRunes STS2 模组安装

## 当前快照

- 状态: 已完成
- 目标: 解释并complete installation of the local `HextechRunes V0.5.2公开版可用.zip` mod 带 Steam Slay the Spire 2.
- 阻塞: 无。
- 下一步: 无；从 Steam 启动游戏检查 modded 状态。
- 更新时间: 2026-05-02 21:07:38 +0800
...
- 已安装 game path: `/home/loviya/.steam/debian-installation/steamapps/common/Slay the Spire 2`
- Steam app id: `2868840`; current Steam branch in manifest: `public-beta`.
- 没有现有的 `mods` directory was present in the game folder during inspection.
- After the user's first paste failed 因为 a newline entered the long zip path, the mod was installed directly 带 the exact quoted path.
...
- 不要execute the DLL during inspection.
- Recommend preserving the packaged `HextechRunes` folder under the game `mods` directory:
  - `/home/loviya/.steam/debian-installation/steamapps/common/Slay the Spire 2/mods/HextechRunes/HextechRunes.json`
  - `/home/loviya/.steam/debian-installation/steamapps/common/Slay the Spire 2/mods/HextechRunes/HextechRunes.pck`
  - `/home/loviya/.steam/debian-installation/steamapps/common/Slay the Spire 2/mods/HextechRunes/HextechRunes.dll`

## 本地 Mod Package Was Identified S

afely

- 更新时间: 2026-05-02 20:45:49 +0800
- 工作目录: `/home/loviya`
- 来源指令: 使用 WeChat 收到的 `HextechRunes V0.5.2公开版可用.zip` 作为 Steam Slay the Spire 2 mod。
- 问题:
...
## Long Path Paste 失败, Direct 安装 已完成

- 更新时间: 2026-05-02 21:07:38 +0800
- 工作目录: `/home/loviya`
- 来源指令: 用户执行 `unzip -o "$ZIP" 'HextechRunes/*' -d "$GAME/mods"` 后提示找不到 zip。
- 问题:
...
## 解释The Mods Directory Convention

- 更新时间: 2026-05-02 21:24:00 +0800
- 工作目录: `/home/loviya`
- 来源指令: 用户询问为什么知道要在 Slay the Spire 2 目录下建立 `mods`，这是什么规范。
- 问题:
