...
cwd: /home/loviya
summary: 诊断 zsh 迁移后明显慢于 bash 的原因，并在安全前提下优化启动速度。
tags:
  - zsh
  - shell
  - performance
...
- 状态: 已完成
- 目标: 找出 zsh 比 bash 慢很多的主要原因，并在不破坏现有功能的前提下优化启动速度。
- 阻塞: 无。
- 下一步: 无。
- 更新时间: 2026-05-17 17:57:00 +0800
...
- 更新时间: 2026-05-17 17:45:04 +0800
- 工作目录: `/home/loviya`
- 来源指令: `我发现现在使用zsh比bash慢很多`
- 问题:
