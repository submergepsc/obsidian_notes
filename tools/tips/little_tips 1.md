...
- Windows Terminal / `cmd` / `powershell` / `pwsh`：[[../terminal有关问题或者脚本有关问题]]
...
- 文件名有空格或特殊字符，优先看：[[文件名空格解决方案]]
- 复杂文件名批量处理：[[带有复杂文件名文件的批量删除]]
...
- Windows 小技巧速查：[[../win_little_tips]]
- Windows 自启动：[[windows系统自启有关]]
- Windows 核心系统工具：[[../tools/Windows 核心系统工与运行命令指南]]
