...
![](assets/Pasted%20image%2020260322183951.png)
下载好文件打开后，双击main.exe运行依次输入5,2,1
![](assets/Pasted%20image%2020260322184545.png)
、
### 打开抖音，复制地址
可以看到这个抖音视频是不能从官方下载的，此时我们复制链接，
![](assets/Pasted%20image%2020260322184726.png)

### 输入链接回车
![](assets/Pasted%20image%2020260322184846.png)
##### 在`DouK-Downloader_V5.7_Windows_X64\_internal\Volume\Download`相对目录下可以看到视频已经下载了
![](assets/Pasted%20image%2020260322184955.png)

#### tips1:更改默认下载路径
进入`_internal\Volume`,打开里面的`settings.json`文件
查找root键，修改目标路径，注意需要使用`/`或者`\\\\`进行转义
![](assets/Pasted%20image%2020260322185223.png)
...
![](assets/Pasted%20image%2020260322191923.png)
#### 完结撒花
最近看到一些图形化动画讲述各种技术原理，一口气视频等感觉非常有意思，就想下载下来自己试着制作。
![](assets/Pasted%20image%2020260322190301.png)