...
- Source: https://oi-wiki.org/tools/compiler/
...
```text 1 2 3 ``` |  ```text Set-ExecutionPolicy RemoteSigned -Scope CurrentUser irm get . scoop . sh | iex scoop install mingw-winlibs ```   
---|---  
...
```text 1 ``` |  ```text sudo apt update ```   
---|---  
  
再使用命令直接安装即可：

```text 1 ``` |  ```text sudo apt install g++ ```   
---|---  
...
```text 1 ``` |  ```text sudo pacman -Syu gcc ```   
---|---  
...
```text 1 ``` |  ```text sudo zypper in gcc-c++ ```   
---|---  
...
```text 1 2 ``` |  ```text brew upgrade brew update ```   
---|---  
  
再使用命令直接安装即可：

```text 1 ``` |  ```text brew install gcc ```   
---|---  
...
```text 1 2 3 4 ``` |  ```text clang version 15.0.1 Target: x86_64-pc-windows-msvc Thread model: posix InstalledDir: <omitted> ```   
---|---  
...
```text 1 2 3 ``` |  ```text Set-ExecutionPolicy RemoteSigned -Scope CurrentUser irm get . scoop . sh | iex scoop install llvm ```   
---|---  
...
```text 1 ``` |  ```text sudo zypper in llvm clang ```   
---|---  
...
* * *
  ...
  1. [Alternative Python Implementations | Python.org](https://www.python.org/download/alternatives/) ↩

  2. [Eclipse Temurin](https://adoptium.net/) 即为原 [AdoptOpenJDK](https://adoptopenjdk.net/)，后者已于 2021 年 7 月移交至 [Eclipse 基金会](https://www.eclipse.org/org/foundation/)．具体可见 [本声明](https://blog.adoptopenjdk.net/2021/03/transition-to-eclipse-an-update/)． ↩

* * *

>  __本页面最近更新： 2026/1/7 08:56:54，[更新历史](https://github.com/OI-wiki/OI-wiki/commits/master/docs/tools/compiler.md)  
>  __发现错误？想一起完善？[在 GitHub 上编辑此页！](https://oi-wiki.org/edit-landing/?ref=/tools/compiler.md "edit.link.title")  
>  __本页面贡献者：[Tiphereth-A](https://github.com/Tiphereth-A), [alphagocc](https://github.com/alphagocc), [argvchs](https://github.com/argvchs), [CoelacanthusHex](https://github.com/CoelacanthusHex), [Enter-tainer](https://github.com/Enter-tainer), [Great-designer](https://github.com/Great-designer), [HeRaNO](https://github.com/HeRaNO), [Qubik65536](https://github.com/Qubik65536), [renbaoshuo](https://github.com/renbaoshuo), [Suyun114](https://github.com/Suyun114)  
