...
- Source: https://oi-wiki.org/tools/editor/vscode/
...
如果安装了 VS Code 与 Code Runner 后，代码仍然无法运行，很有可能是因为系统尚未安装 C/C++ 的运行环境，参考 [Hello, World! 页面](../../../lang/helloworld/) 以安装．
...
如果需要采用 LLDB，需要安装另外一款扩展1——[CodeLLDB](https://github.com/vadimcn/vscode-lldb/)．从该项目的 Release 页面下载 .vsix 文件后2，从 VS Code 的扩展页面安装．
...
官方快捷键 PDF 如下，也可以在 VS Code 中按下`Ctrl`+`Shift`+`P`打开命令面板并输入命令 `> Help: Keyboard Shortcuts Reference` 打开．3
...
按住`Alt`并单击即可在编辑器中添加光标，多数编辑操作都可同时进行；按住鼠标中键并在编辑器中拖动也可添加多行光标，如图：

![](./images/vscode-12.gif)

按`Ctrl`+`F2`可在编辑器中同时更改所有匹配项，也可以在右键菜单中找到 Change All Occurrences，如图：
...
* * *
  ...
  3. [VS Code 官方文档](https://code.visualstudio.com/docs/)． ↩

* * *

>  __本页面最近更新： 2026/2/1 18:56:41，[更新历史](https://github.com/OI-wiki/OI-wiki/commits/master/docs/tools/editor/vscode.md)  
>  __发现错误？想一起完善？[在 GitHub 上编辑此页！](https://oi-wiki.org/edit-landing/?ref=/tools/editor/vscode.md "edit.link.title")  
>  __本页面贡献者：[NachtgeistW](https://github.com/NachtgeistW), [Tiphereth-A](https://github.com/Tiphereth-A), [mgt](mailto:i@margatroid.xyz), [Xeonacid](https://github.com/Xeonacid), [xiaofu-15191](https://github.com/xiaofu-15191), [Enter-tainer](https://github.com/Enter-tainer), [ouuan](https://github.com/ouuan), [xkww3n](mailto:i@xkww3n.life), [abc1763613206](https://github.com/abc1763613206), [c-forrest](https://github.com/c-forrest), [CCXXXI](https://github.com/CCXXXI), [Chrogeek](https://github.com/Chrogeek), [fuxianhu](https://github.com/fuxianhu), [HeliumOI](https://github.com/HeliumOI), [Ir1d](https://github.com/Ir1d), [Pinghigh](https://github.com/Pinghigh), [Sekakou](https://github.com/Sekakou), [xyf007](https://github.com/xyf007), [aofall](https://github.com/aofall), [ChungZH](https://github.com/ChungZH), [CoelacanthusHex](https://github.com/CoelacanthusHex), [HeRaNO](https://github.com/HeRaNO), [Junyan721113](https://github.com/Junyan721113), [keepthethink](https://github.com/keepthethink), [Marcythm](https://github.com/Marcythm), [partychicken](https://github.com/partychicken), [Persdre](https://github.com/Persdre), [shuzhouliu](https://github.com/shuzhouliu), [StudyingFather](https://github.com/StudyingFather), [xkww3n](https://github.com/xkww3n)  
