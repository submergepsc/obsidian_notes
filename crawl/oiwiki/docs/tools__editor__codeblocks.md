...
- Source: https://oi-wiki.org/tools/editor/codeblocks/

# Code::Blocks

## 简介

Code::Blocks 是一个使用 C++ 开发的开源集成开发环境（IDE），采用 wxWidgets 作为图形界面库．该项目始于 2001 年，目前由官方社区维护，主要用于 C、C++ 和 Fortran 等编程语言的开发．1
...
参考本站的 [编译器](../../compiler/) 安装指南，下载并安装你需要的编译器．
...
* * *
  ...
  1. [Code::Blocks - 维基百科](https://zh.wikipedia.org/wiki/Code::Blocks) ↩

* * *

>  __本页面最近更新： 2026/1/7 08:56:54，[更新历史](https://github.com/OI-wiki/OI-wiki/commits/master/docs/tools/editor/codeblocks.md)  
>  __发现错误？想一起完善？[在 GitHub 上编辑此页！](https://oi-wiki.org/edit-landing/?ref=/tools/editor/codeblocks.md "edit.link.title")  
>  __本页面贡献者：[Tiphereth-A](https://github.com/Tiphereth-A), [HeRaNO](https://github.com/HeRaNO), [yee114514](https://github.com/yee114514), [yyyu-star](https://github.com/yyyu-star)  
