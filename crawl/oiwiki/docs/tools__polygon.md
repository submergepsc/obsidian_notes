...
如果需要自己编写 checker，请参考 [checker 教程](../testlib/checker/)．

下面的 "Checker tests" 是通过 "Add test" 添加若干组输出以及对应的期望评测结果，然后点击 "Run tests" 就可以测试 checker 是否正确返回了评测结果．

### Interactor

仅 IO 式交互题需要，请参考 [interactor 教程](../testlib/interactor/)．

### Validator

validator 用来检测数据合法性，编写请参考 [validator 教程](../testlib/validator/)．
...
在 Polygon 上，推荐的做法是使用少量 **带命令行参数** 的 [generator](../testlib/generator/) 来生成数据，而不是写一堆 generator 或者每生成一组数据都修改 generator．并且，只需要生成输入，输出会自动生成．
...
>  __本页面最近更新： 2026/1/7 08:56:54，[更新历史](https://github.com/OI-wiki/OI-wiki/commits/master/docs/tools/polygon.md)  
>  __发现错误？想一起完善？[在 GitHub 上编辑此页！](https://oi-wiki.org/edit-landing/?ref=/tools/polygon.md "edit.link.title")  
>  __本页面贡献者：[ouuan](https://github.com/ouuan), [Ir1d](https://github.com/Ir1d), [NachtgeistW](https://github.com/NachtgeistW), [ZnPdCo](https://github.com/ZnPdCo), [abc1763613206](https://github.com/abc1763613206), [c-forrest](https://github.com/c-forrest), [CCXXXI](https://github.com/CCXXXI), [Enter-tainer](https://github.com/Enter-tainer), [HeRaNO](https://github.com/HeRaNO), [Tiphereth-A](https://github.com/Tiphereth-A)  
