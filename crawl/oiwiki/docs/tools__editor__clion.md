...
- Source: https://oi-wiki.org/tools/editor/clion/
...
```text 1 2 3 ``` |  ```text sudo apt install make cmake # build tools sudo apt install gcc g++ gdb # compiler and debugger sudo apt install clang clang++ llvm lldb # you can also choose to use clang toolchain ```   
---|---  
  
##### Arch Linux 及其衍生发行版

```text 1 2 3 ``` |  ```text sudo pacman -S make cmake # build tools sudo pacman -S gcc g++ gdb # compiler and debugger sudo pacman -S clang clang++ llvm lldb # you can also choose to use clang toolchain ```   
---|---  
  
##### Fedora/RHEL/CentOS/Rocky Linux

```text 1 2 3 ``` |  ```text sudo dnf install make cmake # build tools sudo dnf install gcc g++ gdb # compiler and debugger sudo dnf install clang clang++ llvm lldb # you can also choose to use clang toolchain ```   
---|---  
...
```text 1 ``` |  ```text add_compile_options ( -std=c++17 -DDEBUG ) ```   
---|---  
...
>  __本页面最近更新： 2026/2/25 00:43:13，[更新历史](https://github.com/OI-wiki/OI-wiki/commits/master/docs/tools/editor/clion.md)  
>  __发现错误？想一起完善？[在 GitHub 上编辑此页！](https://oi-wiki.org/edit-landing/?ref=/tools/editor/clion.md "edit.link.title")  
>  __本页面贡献者：[Tiphereth-A](https://github.com/Tiphereth-A), [yanboishere](https://github.com/yanboishere), [Enter-tainer](https://github.com/Enter-tainer), [Great-designer](https://github.com/Great-designer), [HeRaNO](https://github.com/HeRaNO), [inclyc](https://github.com/inclyc), [lihaoyu1234](https://github.com/lihaoyu1234), [RIvance](https://github.com/RIvance), [shuzhouliu](https://github.com/shuzhouliu), [TrickEye](https://github.com/TrickEye)  
