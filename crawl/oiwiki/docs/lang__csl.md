...
STL 即标准模板库（Standard Template Library），是 C++ 标准库的一部分，里面包含了一些模板化的通用的数据结构和算法．由于其模板化的特点，它能够兼容自定义的数据类型，避免大量的造轮子工作．NOI 和 ICPC 赛事都支持 STL 库的使用，因此合理利用 STL 可以避免编写无用算法，并且充分利用编译器对模板库优化提高效率．STL 库的详细介绍请参见对应的页面：[STL 容器](container/) 和 [STL 算法](algorithm/)．
...
>  __本页面最近更新： 2026/4/5 17:27:58，[更新历史](https://github.com/OI-wiki/OI-wiki/commits/master/docs/lang/csl/index.md)  
>  __发现错误？想一起完善？[在 GitHub 上编辑此页！](https://oi-wiki.org/edit-landing/?ref=/lang/csl/index.md "edit.link.title")  
>  __本页面贡献者：[Ir1d](https://github.com/Ir1d), [cmpute](https://github.com/cmpute), [Tiphereth-A](https://github.com/Tiphereth-A), [Xeonacid](https://github.com/Xeonacid), [opsiff](https://github.com/opsiff), [Enter-tainer](https://github.com/Enter-tainer), [Henry-ZHR](https://github.com/Henry-ZHR), [real01bit](https://github.com/real01bit), [SSJ-ZYJ](https://github.com/SSJ-ZYJ), [StudyingFather](https://github.com/StudyingFather), [Suyun514](mailto:suyun514@qq.com), [zeyu10](https://github.com/zeyu10)  
