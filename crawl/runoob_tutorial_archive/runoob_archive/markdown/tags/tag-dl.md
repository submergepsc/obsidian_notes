...
- Source: https://www.runoob.com/tags/tag-dl.html
...
## 标签定义及使用说明
 ...
 标签与 [](https://www.runoob.com/tag-dt.html) （定义项目/名字）和 [](https://www.runoob.com/tag-dd.html) （描述每一个项目/名字）一起使用。
...
在 HTML 4.01 中， 标签定义一个定义列表。


在 HTML5 中， 标签定义一个描述列表。
...
HTML 教程：[HTML 列表](https://www.runoob.com/html-lists.html)
	  ...
	  AI 思考中...
			...
			** [HTML  标签](https://www.runoob.com/tag-div.html)
			[HTML
**标签](https://www.runoob.com/tag-dt.html) ** ### 点我分享笔记 ** 取消 * * 分享笔记 - 昵称昵称 (必填) - 邮箱邮箱 (必填) - 引用地址引用地址 在线实例**
