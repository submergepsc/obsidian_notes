...
- Source: https://www.runoob.com/tags/tag-ins.html
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml_del)
...
提示：**您也可以看看标记已删除文本的 [](https://www.runoob.com/tag-del.html) 标签。


**提示：** 和  一起使用，描述文档中的更新和修正。浏览器通常会在已删除文本上添加一条删除线，在新插入文本下添加一条下划线。
...
## 事件属性
 ...
 标签支持 [HTML 的事件属性](https://www.runoob.com/ref-eventattributes.html)。
	  ...
	  AI 思考中...
			...
			** [HTML  标签](https://www.runoob.com/tag-kbd.html)
			[HTML input 标签](https://www.runoob.com/tag-input.html) **
