...
- Source: https://www.runoob.com/tags/att-object-data.html

[![HTML object 标签参考手册](https://www.runoob.com/images/up.gif) HTML 标签](https://www.runoob.com/tag-object.html)
...
| 值 | 描述 |
| --- | --- |
| URL | 规定对象所用资源的 URL。可能的值： 绝对 URL - 指向另一个网站上的数据（比如 href="http://www.example.com/helloworld.swg"） 相对 URL - 指向网站内的数据（比如 href="helloworld.swg"） |
...
[![HTML object 标签参考手册](https://www.runoob.com/images/up.gif) HTML  标签](https://www.runoob.com/tag-object.html)
	  ...
	  AI 思考中...
			...
			** [HTML object border 属性](https://www.runoob.com/att-object-border.html)
			[HTML object form 属性](https://www.runoob.com/att-object-form.html) **
