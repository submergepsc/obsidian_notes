...
- Source: https://www.runoob.com/tags/tag-legend.html
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml_fieldset)
...
The  元素为 [](https://www.runoob.com/tag-fieldset.html)元素定义标题。
...
在 HTML 4.01中 "align" 属性已被废弃, HTML5不支持该属性。不建议使用。 请使用 CSS 来设置  元素的对齐方式。
...
## 事件属性
 ...
 标签支持所有 [HTML事件属性](https://www.runoob.com/ref-eventattributes.html)。
	  ...
	  AI 思考中...
			...
			** [HTML  标签](https://www.runoob.com/tag-li.html)
			[HTML5  标签](https://www.runoob.com/tag-keygen.html) **
