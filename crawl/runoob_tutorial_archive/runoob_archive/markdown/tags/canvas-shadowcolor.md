...
- Source: https://www.runoob.com/tags/canvas-shadowcolor.html
...
var c=document.getElementById("myCanvas");var
	ctx=c.getContext("2d");ctx.shadowBlur=20;
	ctx.shadowColor="black";ctx.fillStyle="red";ctx.fillRect(20,20,100,80);
```


**[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml5_canvas_shadowcolor)
...
**注意：**请将 shadowColor 属性与 [shadowBlur](https://www.runoob.com/canvas-shadowblur.html) 属性一起使用，来创建阴影。


**提示：**请通过使用 [shadowOffsetX](https://www.runoob.com/canvas-shadowoffsetx.html) 和 [shadowOffsetY](https://www.runoob.com/canvas-shadowoffsety.html) 属性来调节阴影效果。
...
[![HTML canvas 参考手册](https://www.runoob.com/images/up.gif) HTML canvas 参考手册](https://www.runoob.com/ref-canvas.html)
	  ...
	  AI 思考中...
			...
			** [HTML canvas strokeStyle 属性](https://www.runoob.com/canvas-strokestyle.html)
			[HTML canvas shadowBlur 属性](https://www.runoob.com/canvas-shadowblur.html) **
