...
- Source: https://www.runoob.com/tags/av-prop-src.html
...
**[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml5_av_prop_src)
...
Internet Explorer 10、Firefox、Opera、Chrome 和 Safari 支持 src 属性。


注意：**Internet Explorer 9 及之前的版本不支持 src 属性。
