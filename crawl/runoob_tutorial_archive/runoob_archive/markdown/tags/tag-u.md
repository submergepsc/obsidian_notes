...
- Source: https://www.runoob.com/tags/tag-u.html
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml_u)
...
提示：**请尽量避免使用  为文本加下划线，用户会把它混淆为一个超链接。


**注释：**HTML5 规范建议开发者尽量使用其他元素替代  元素。
...
在 HTML 中，元素 已废弃（ 元素被用来定义下划线）。


HTML5 中重新定义了  元素，它定义与常规文本风格不同的文本，像拼写错误的单词或者汉语中的专有名词。
