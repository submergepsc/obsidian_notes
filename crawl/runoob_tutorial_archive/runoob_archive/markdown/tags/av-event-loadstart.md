...
- Source: https://www.runoob.com/tags/av-event-loadstart.html
...
```
myVid=document.getElementById("video1");myVid.onloadstart=alert("Starting
	to load video");
```


**[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml5_av_event_loadstart)
...
[在 HTML 元素上使用 onloadstart 属性](https://www.runoob.com/try/try.php?filename=tryhtml5_av_event_loadstart_html)


[使用 addEventListener() 来监听 loadstart 事件](https://www.runoob.com/try/try.php?filename=tryhtml5_av_event_loadstart_el)
...
[![HTML audio/video 标签参考手册](https://www.runoob.com/images/up.gif) HTML 音频/视频 DOM 参考手册](https://www.runoob.com/ref-av-dom.html)
	  ...
	  AI 思考中...
			...
			** [HTML 音频/视频 DOM loadedmetadata 事件](https://www.runoob.com/av-event-loadedmetadata.html)
			[HTML 音频/视频 DOM progress 事件](https://www.runoob.com/av-event-progress.html) **
