...
- Source: https://www.runoob.com/tags/tag-sup.html
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml_sup)
...
## 标签定义及使用说明
 ...
 标签定义上标文本。上标文本将会显示在当前文本流中字符高度的一半为基准线的上方，但是与当前文本流中文字的字体和字号都是一样的。上标文本能用来添加脚注，比如 WWW[1]。


提示：**请使用 [](https://www.runoob.com/tag-sub.html) 标签定义下标文本。
...
## 事件属性
 ...
 标签支持 [HTML 的事件属性](https://www.runoob.com/ref-eventattributes.html)。
	  ...
	  AI 思考中...
			...
			** [HTML  标签](https://www.runoob.com/tag-summary.html)
