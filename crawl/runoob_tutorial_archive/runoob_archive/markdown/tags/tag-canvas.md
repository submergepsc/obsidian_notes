...
- Source: https://www.runoob.com/tags/tag-canvas.html
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml5_canvas)
...
**提示：**如想了解 canvas 对象的所有属性和方法，请参阅[HTML 画布参考手册](https://www.runoob.com/ref-canvas.html)。
...
## 事件属性
 ...
 标签支持 [HTML 的事件属性](https://www.runoob.com/ref-eventattributes.html)。
	  ...
	  AI 思考中...
			...
			** [HTML ** 标签](https://www.runoob.com/tag-br.html)
