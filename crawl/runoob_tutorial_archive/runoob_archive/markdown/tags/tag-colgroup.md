...
- Source: https://www.runoob.com/tags/tag-colgroup.html
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml_colgroup_test)
...
注释：**只能在  元素之内，在任何一个  元素之后，在任何一个 、、、 元素之前使用  标签。


**提示：**如果想对  中的某列定义不同的属性，请在  标签内使用 [](https://www.runoob.com/tag-col.html) 标签。
...
## 事件属性
 ...
 标签支持 [HTML 的事件属性](https://www.runoob.com/ref-eventattributes.html)。
	  ...
	  AI 思考中...
			...
			** [HTML  标签](https://www.runoob.com/tag-col.html)
			[HTML  标签](https://www.runoob.com/tag-command.html) **
