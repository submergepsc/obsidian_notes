...
- Source: https://www.runoob.com/tags/canvas-stroke.html
...
**[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml5_canvas_stroke)
...
Internet Explorer 9、Firefox、Opera、Chrome 和 Safari 支持 stroke() 方法。
...
**提示：**请使用 [strokeStyle](https://www.runoob.com/canvas-strokestyle.html) 属性来绘制另一种颜色/渐变。
...
[![HTML canvas 参考手册](https://www.runoob.com/images/up.gif) HTML canvas 参考手册](https://www.runoob.com/ref-canvas.html)
	  ...
	  AI 思考中...
			...
			** [HTML canvas fill() 方法](https://www.runoob.com/canvas-fill.html)
			[HTML canvas beginPath() 方法](https://www.runoob.com/canvas-beginpath.html) **
