...
- Source: https://www.runoob.com/tags/canvas-globalalpha.html
...
首先，绘制一个红色的矩形，然后将透明度 (globalAlpha) 设置为 0.2，然后再绘制一个蓝色和一个绿色的矩形：
...
**[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml5_canvas_globalalpha)
