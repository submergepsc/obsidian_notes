...
- Source: https://www.runoob.com/tags/tag-caption.html
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml_caption_test)
...
HTML 4.01 [已废弃](https://www.runoob.com/NewWindow('deprecated.html) align 属性。
...
## 事件属性
 ...
 标签支持 [HTML 的事件属性](https://www.runoob.com/ref-eventattributes.html)。
	  ...
	  AI 思考中...
			...
			** [HTML  标签](https://www.runoob.com/tag-canvas.html)
			[HTML  标签](https://www.runoob.com/tag-center.html) **
