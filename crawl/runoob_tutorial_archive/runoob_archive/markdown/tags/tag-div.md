...
- Source: https://www.runoob.com/tags/tag-div.html
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml_div_test)
...
提示：** 元素经常与 CSS 一起使用，用来布局网页。


**注释：**默认情况下，浏览器通常会在  元素前后放置一个换行符。然而，您可以通过使用 CSS 改变这种情况。
...
| 属性 | 值 | 描述 |
| --- | --- | --- |
| align | left right center justify | HTML5 不支持。HTML 4.01 已废弃。 规定 元素中的内容的对齐方式。 |
...
HTML 教程：[HTML 布局](https://www.runoob.com/html-layout.html)
	  ...
	  AI 思考中...
			...
			** [HTML  标签](https://www.runoob.com/tag-dir.html)
			[HTML  标签](https://www.runoob.com/tag-dl.html) **
