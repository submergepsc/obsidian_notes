...
- Source: https://www.runoob.com/tags/av-event-loadedmetadata.html
...
```
myVid=document.getElementById("video1");myVid.onloadedmetadata=alert("Meta
	data for video loaded");
```


**[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml5_av_event_loadedmetadata)
...
[在 HTML 元素上使用 onloadedmetadata 属性](https://www.runoob.com/try/try.php?filename=tryhtml5_av_event_loadedmetadata_html)


[使用 addEventListener() 来监听 loadedmetadata 事件](https://www.runoob.com/try/try.php?filename=tryhtml5_av_event_loadedmetadata_el)


---

[![HTML audio/video 标签参考手册](https://www.runoob.com/images/up.gif) HTML Audio/Video DOM 参考手册](https://www.runoob.com/ref-av-dom.html)
	  ...
	  AI 思考中...
			...
			** [HTML 音频/视频 DOM loadeddata 事件](https://www.runoob.com/av-event-loadeddata.html)
			[HTML 音频/视频 DOM loadstart 事件](https://www.runoob.com/av-event-loadstart.html) **
