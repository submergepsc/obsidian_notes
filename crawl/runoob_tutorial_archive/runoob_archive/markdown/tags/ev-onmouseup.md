...
- Source: https://www.runoob.com/tags/ev-onmouseup.html
...
**[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml5_ev_onmousedown)
...
提示：** 与 onmouseup 事件相关的事件触发顺序 (左/中鼠标按钮):
...
与 onmouseup 事件相关的事件触发顺序(右边鼠标按钮):
...
[![HTML 事件属性](https://www.runoob.com/images/up.gif) HTML 事件属性](https://www.runoob.com/ref-eventattributes.html)
	  ...
	  AI 思考中...
			...
			** [HTML onmouseover 事件属性](https://www.runoob.com/ev-onmouseover.html)
			[HTML audio controls 属性](https://www.runoob.com/att-audio-controls.html) **
