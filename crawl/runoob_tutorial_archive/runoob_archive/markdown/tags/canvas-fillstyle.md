...
- Source: https://www.runoob.com/tags/canvas-fillstyle.html
...
**[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml5_canvas_fillstyle)
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml5_canvas_fillstyle_gradient2)
...
var c=document.getElementById("myCanvas");var ctx=c.getContext("2d");
	var img=document.getElementById("lamp");var
	pat=ctx.createPattern(img,"repeat");ctx.rect(0,0,150,100);
	ctx.fillStyle=pat;ctx.fill();
```


[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml5_canvas_createpattern)
...
[![HTML canvas 参考手册](https://www.runoob.com/images/up.gif) HTML canvas 参考手册](https://www.runoob.com/ref-canvas.html)
	  ...
	  AI 思考中...
			...
			** [HTML tr valign 属性](https://www.runoob.com/att-tr-valign.html)
