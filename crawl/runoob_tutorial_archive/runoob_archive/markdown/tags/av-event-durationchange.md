...
- Source: https://www.runoob.com/tags/av-event-durationchange.html
...
```
myVid=document.getElementById("video1");myVid.ondurationchange=alert("The
	video duration has changed");
```


**[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml5_av_event_durationchange)
...
[在 HTML 元素上使用 ondurationchange 属性](https://www.runoob.com/try/try.php?filename=tryhtml5_av_event_durationchange_html)


[使用 addEventListener() 来监听 durationchange 事件](https://www.runoob.com/try/try.php?filename=tryhtml5_av_event_durationchange_el)
...
[![HTML audio/video 标签参考手册](https://www.runoob.com/images/up.gif) HTML 音频/视频 DOM 参考手册](https://www.runoob.com/ref-av-dom.html)
	  ...
	  AI 思考中...
			...
			** [HTML 音频/视频 DOM canplaythrough 事件](https://www.runoob.com/av-event-canplaythrough.html)
