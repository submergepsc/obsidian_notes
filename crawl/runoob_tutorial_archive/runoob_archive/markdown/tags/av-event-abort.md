...
- Source: https://www.runoob.com/tags/av-event-abort.html
...
```
var vid = document.getElementById("myVideo");vid.onabort =
	function() {    alert("视频终止加载");};
```
...
**注意：**Windows 7 中的 Internet Explorer 11 不支持 abort 事件。
...
[![HTML audio/video 标签参考手册](https://www.runoob.com/images/up.gif) HTML 音频/视频 DOM 参考手册](https://www.runoob.com/ref-av-dom.html)
	  ...
	  AI 思考中...
			...
			** [HTML ontoggle 事件属性](https://www.runoob.com/ev-ontoggle.html)
