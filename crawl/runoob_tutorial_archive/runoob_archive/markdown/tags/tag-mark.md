...
- Source: https://www.runoob.com/tags/tag-mark.html
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml5_mark)
...
Internet Explorer 9+、Firefox、Opera、Chrome 和 Safari 支持  标签。


注意：**Internet Explorer 8 及更早版本不支持  标签。
...
## 事件属性
 ...
 标签支持所有 [HTML事件属性](https://www.runoob.com/ref-eventattributes.html)。
	  ...
	  AI 思考中...
			...
			** [HTML  标签](https://www.runoob.com/tag-menu.html)
			[HTML  标签](https://www.runoob.com/tag-map.html) **
