...
- Source: https://www.runoob.com/tags/ev-onkeypress.html

[![HTML 事件属性](https://www.runoob.com/images/up.gif) HTML 事件属性](https://www.runoob.com/ref-eventattributes.html)
...
**[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml5_ev_onkeypress)
...
**注意：** onkeypress 事件在所有浏览器中不能触发所有按键(例如：ALT, CTRL, SHIFT, ESC) 。如果只对用户是否已经按下一个按键检测， 可以使用 [onkeydown](https://www.runoob.com/ev-onkeydown.html) 取代, onkeydown被所有按键触发。


**注意：** onkeypress 属性不能使用与以下元素: , , , , , , , , , , 或。
...
[![HTML 事件属性](https://www.runoob.com/images/up.gif) HTML 事件属性](https://www.runoob.com/ref-eventattributes.html)
	  ...
	  AI 思考中...
			...
			** [HTML onkeydown 事件属性](https://www.runoob.com/ev-onkeydown.html)
			[HTML onkeyup 事件属性](https://www.runoob.com/ev-onkeyup.html) **
