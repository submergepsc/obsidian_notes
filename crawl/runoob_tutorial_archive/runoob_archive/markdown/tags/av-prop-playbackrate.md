...
- Source: https://www.runoob.com/tags/av-prop-playbackrate.html
...
```
myVid=document.getElementById("video1");myVid.playbackRate=0.5;
```


**[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml5_av_prop_playbackrate)
...
注意：**Internet Explorer 9 及之前的版本不支持 playbackRate 属性。
...
[![HTML audio/video 标签参考手册](https://www.runoob.com/images/up.gif) HTML 音频/视频 DOM 参考手册](https://www.runoob.com/ref-av-dom.html)
	  ...
	  AI 思考中...
			...
			** [HTML 音频/视频 DOM paused 属性](https://www.runoob.com/av-prop-paused.html)
			[HTML 音频/视频 DOM played 属性](https://www.runoob.com/av-prop-played.html) **
