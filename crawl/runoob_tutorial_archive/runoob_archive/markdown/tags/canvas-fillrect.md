...
- Source: https://www.runoob.com/tags/canvas-fillrect.html
...
**[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml5_canvas_fillrect)
...
**提示：**请使用 [fillStyle](https://www.runoob.com/canvas-fillstyle.html) 属性来设置用于填充绘图的颜色、渐变或模式。
...
[![HTML canvas 参考手册](https://www.runoob.com/images/up.gif) HTML canvas 参考手册](https://www.runoob.com/ref-canvas.html)
	  ...
	  AI 思考中...
			...
			** [HTML canvas rect() 方法](https://www.runoob.com/canvas-rect.html)
			[HTML canvas strokeRect() 方法](https://www.runoob.com/canvas-strokerect.html) **
