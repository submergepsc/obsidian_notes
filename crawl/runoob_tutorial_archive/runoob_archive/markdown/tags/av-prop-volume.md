...
- Source: https://www.runoob.com/tags/av-prop-volume.html
...
```
myVid=document.getElementById("video1");myVid.volume=0.2;
```


**[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml5_av_prop_volume)
