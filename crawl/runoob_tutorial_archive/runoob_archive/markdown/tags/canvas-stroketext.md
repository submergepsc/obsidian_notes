...
- Source: https://www.runoob.com/tags/canvas-stroketext.html
...
使用 strokeText()，在画布上写文本 "Hello world!" 和 "Big smile!"（带渐变）：
...
**[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml5_canvas_stroketext)
...
**提示：**请使用 [font](https://www.runoob.com/canvas-font.html) 属性来定义字体和字号，并使用 [strokeStyle](https://www.runoob.com/canvas-strokestyle.html) 属性以另一种颜色/渐变来渲染文本。
