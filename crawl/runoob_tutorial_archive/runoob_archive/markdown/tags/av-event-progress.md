...
- Source: https://www.runoob.com/tags/av-event-progress.html
...
```
myVid=document.getElementById("video1");myVid.onprogress=alert("Downloading
	video");
```


**[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml5_av_event_progress)
...
[在 HTML 元素上使用 onprogress 属性](https://www.runoob.com/try/try.php?filename=tryhtml5_av_event_progress_html)


[使用 addEventListener() 来监听 progress 事件](https://www.runoob.com/try/try.php?filename=tryhtml5_av_event_progress_el)
...
[![HTML audio/video 标签参考手册](https://www.runoob.com/images/up.gif) HTML 音频/视频 DOM 参考手册](https://www.runoob.com/ref-av-dom.html)
	  ...
	  AI 思考中...
			...
			** [HTML 音频/视频 DOM loadstart 事件](https://www.runoob.com/av-event-loadstart.html)
			[HTML5 onafterprint 事件属性](https://www.runoob.com/ev-onafterprint.html) **
