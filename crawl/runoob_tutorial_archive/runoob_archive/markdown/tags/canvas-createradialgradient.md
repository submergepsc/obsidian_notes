...
- Source: https://www.runoob.com/tags/canvas-createradialgradient.html
...
var c=document.getElementById("myCanvas");var
	...
	// Fill with gradient
	ctx.fillStyle=grd;ctx.fillRect(10,10,150,100);
```


**[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml5_canvas_createradialgradient)
...
[![HTML canvas 参考手册](https://www.runoob.com/images/up.gif) HTML canvas 参考手册](https://www.runoob.com/ref-canvas.html)
	  ...
	  AI 思考中...
			...
			** [HTML canvas createPattern() 方法](https://www.runoob.com/canvas-createpattern.html)
			[HTML canvas addColorStop() 方法](https://www.runoob.com/canvas-addcolorstop.html) **
