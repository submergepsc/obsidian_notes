# HTML 音频/视频 DOM autoplay 属性

- Source: https://www.runoob.com/tags/av-prop-autoplay.html
...
myVid=document.getElementById("video1");
	myVid.autoplay=true;myVid.load();
```


**[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml5_av_prop_autoplay)
...
[![HTML audio/video 标签参考手册](https://www.runoob.com/images/up.gif) HTML 音频/视频 DOM 参考手册](https://www.runoob.com/ref-av-dom.html)
	  ...
	  AI 思考中...
			...
			** [HTML 音频/视频 DOM audioTracks 属性](https://www.runoob.com/av-prop-audiotracks.html)
