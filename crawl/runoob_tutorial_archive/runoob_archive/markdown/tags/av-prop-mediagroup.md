...
- Source: https://www.runoob.com/tags/av-prop-mediagroup.html
...
```
myVid1=document.getElementById("video1");myVid2=document.getElementById("video2");
	myVid1.mediaGroup="test";myVid2.mediaGroup="test";
```


**[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml5_av_prop_mediagroup)
...
[![HTML audio/video 标签参考手册](https://www.runoob.com/images/up.gif) HTML 音频/视频 DOM 参考手册](https://www.runoob.com/ref-av-dom.html)
	  ...
	  AI 思考中...
			...
			** [HTML 音频/视频 DOM loop 属性](https://www.runoob.com/av-prop-loop.html)
			[HTML 音频/视频 DOM muted 属性](https://www.runoob.com/av-prop-muted.html) **
