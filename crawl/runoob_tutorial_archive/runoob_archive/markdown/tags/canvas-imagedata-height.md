...
- Source: https://www.runoob.com/tags/canvas-imagedata-height.html
...
**[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml5_canvas_imagedata_height)
...
Internet Explorer 9、Firefox、Opera、Chrome 和 Safari 支持 ImageData height 属性。
