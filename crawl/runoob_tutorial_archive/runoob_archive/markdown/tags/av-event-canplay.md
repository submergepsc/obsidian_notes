...
- Source: https://www.runoob.com/tags/av-event-canplay.html
...
```
myVid=document.getElementById("video1");myVid.oncanplay=alert("Can
	start playing video");
```


**[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml5_av_event_canplay)
...
[在 HTML 元素上使用 oncanplay 属性](https://www.runoob.com/try/try.php?filename=tryhtml5_av_event_canplay_html)


[使用 addEventListener() 来监听 canplay 事件](https://www.runoob.com/try/try.php?filename=tryhtml5_av_event_canplay_el)
