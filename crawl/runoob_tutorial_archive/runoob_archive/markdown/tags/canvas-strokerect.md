...
- Source: https://www.runoob.com/tags/canvas-strokerect.html
...
**[尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml5_canvas_strokerect)
...
**提示：**请使用 [strokeStyle](https://www.runoob.com/canvas-strokestyle.html) 属性来设置笔触的颜色、渐变或模式。
