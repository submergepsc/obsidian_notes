...
- Source: https://www.runoob.com/svg/svg-feoffset.html
...
SVG 阴影效果可以通过 `` 元素实现，它可以为 SVG 图形元素添加阴影效果，使其看起来更加立体和真实。
...
### 实例 1
 ...
 元素是用于创建阴影效果。我们的想法是采取一个SVG图形（图像或元素）并移动它在 xy 平面上一点儿。


第一个例子偏移一个矩形（带 ），然后混合偏移图像顶部（含 ）：


![feoffset](https://www.runoob.com/images/svg_feoffset.gif)
下面是 SVG 代码：
...
**[尝试一下 »](https://www.runoob.com/try/try.php?filename=trysvg_feoffset0)


点击查看： [查看 SVG 文件](https://www.runoob.com/try/demo_source/feoffset1.svg)。
...
![feoffset2](https://www.runoob.com/images/svg_feoffset2.jpg)
下面是SVG代码：
...
**[尝试一下 »](https://www.runoob.com/try/try.php?filename=trysvg_feoffset2)


点击查看： [查看 SVG 文件](https://www.runoob.com/try/demo_source/feoffset2.svg)。
...
![feoffset3](https://www.runoob.com/images/svg_feoffset3.jpg)
下面是 SVG 代码：
...
**[尝试一下 »](https://www.runoob.com/try/try.php?filename=trysvg_feoffset3)


点击查看： [查看 SVG 文件](https://www.runoob.com/try/demo_source/feoffset3.svg)。
...
![feoffset4](https://www.runoob.com/images/svg_feoffset4.jpg)
下面是 SVG 代码：
...
**[尝试一下 »](https://www.runoob.com/try/try.php?filename=trysvg_feoffset4)


点击查看： [查看 SVG 文件](https://www.runoob.com/try/demo_source/feoffset4.svg)。
...
- `` 元素可以与其他滤镜效果组合使用，例如模糊、颜色矩阵等。
- 偏移效果的偏移量 `dx` 和 `dy` 可以为正值（表示向右或向下偏移）或负值（表示向左或向上偏移）。
- `` 元素通常用于创建阴影效果，结合其他滤镜效果可以实现更加复杂的视觉效果。

通过使用 `` 元素，你可以为SVG图形元素创建偏移效果，使其呈现出更加生动和立体的外观。
