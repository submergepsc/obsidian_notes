...
- Source: https://www.runoob.com/svg/svg-stroke.html

SVG 中的 `stroke` 属性用于定义图形元素的描边（边框）颜色，它可以应用于任何具有轮廓的图形元素，如 ``、``、`` 等。
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=trysvg_stroke0)


点击查看：[查看 SVG 文件](https://www.runoob.com/try/demo_source/stroke0.svg)。
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=trysvg_stroke)


点击查看：[查看 SVG 文件](https://www.runoob.com/try/demo_source/stroke1.svg)。
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=trysvg_stroke2)


点击查看：[查看 SVG 文件](https://www.runoob.com/try/demo_source/stroke2.svg)。
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=trysvg_stroke3)


点击查看：[查看 SVG 文件](https://www.runoob.com/try/demo_source/stroke3.svg)。
