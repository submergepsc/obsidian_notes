...
- Source: https://www.runoob.com/svg/svg-intro.html
...
如果希望首先学习这些内容，请在本站的[首页](https://www.runoob.com/../index/index.html)选择相应的教程。
...
如需阅读更多有关 W3C 的 SVG 活动的信息，请访问我们的 [W3C 教程](https://www.runoob.com/../w3c/index.html)。
...
- W3C目前仍正在研究制定SVG 2，目前最新的草稿发布见[点击这里查看](https://svgwg.org/svg2-draft/) 。
...
- **打开文本编辑器**：使用你喜欢的文本编辑器，如 Visual Studio Code 等，查看 [VScode 教程](https://www.runoob.com/w3cnote/vscode-tutorial.html)。
...
这段代码描述了一个 SVG 画布，宽度为 200 个单位，高度也为 200 个单位。在画布上绘制了一个圆形，圆心坐标为(100, 100)，半径为80个单位，填充颜色为蓝色。
	  ...
	  AI 思考中...
			...
			** [SVG 教程](https://www.runoob.com/svg-tutorial.html)
