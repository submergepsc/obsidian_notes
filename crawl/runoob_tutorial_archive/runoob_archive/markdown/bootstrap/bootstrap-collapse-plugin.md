...
- Source: https://www.runoob.com/bootstrap/bootstrap-collapse-plugin.html

折叠（Collapse）插件可以很容易地让页面区域折叠起来。无论您用它来创建折叠导航还是内容面板，它都允许很多内容选项。

**![](https://www.runoob.com/images/quote.png)如果您想要单独引用该插件的功能，那么您需要引用 collapse.js**。同时，也需要在您的 Bootstrap 版本中引用 [Transition（过渡）插件](https://www.runoob.com/bootstrap-transition-plugin.html)。或者，正如 [Bootstrap 插件概览](https://www.runoob.com/bootstrap-plugins-overview.html) 一章中所提到，您可以引用 *bootstrap.js* 或压缩版的 *bootstrap.min.js*。

您可以使用折叠（Collapse）插件：


- ***创建可折叠的分组或折叠面板（accordion）***，如下所示： ## 实例
```css
...
```
 ** [尝试一下 »](https://www.runoob.com/try/tryit.php?filename=bootstrap3-plugin-collapse-accordion) 结果如下所示： ![折叠面板](https://www.runoob.com/wp-content/uploads/2014/07/accordion_demo.jpg) data-toggle="collapse"** 添加到您想要展开或折叠的组件的链接上。
- **href** 或 **data-target** 属性添加到父组件，它的值是子组件的 *id*。
- **data-parent** 属性把折叠面板（accordion）的 id 添加到要展开或折叠的组件的链接上。
- ***创建不带 accordion 标记的简单的可折叠组件（collapsible）***，如下所示： ## 实例
```css
...
```
 ** [尝试一下 »](https://www.runoob.com/try/tryit.php?filename=bootstrap3-plugin-collapse-simple) 结果如下所示： ![简单的可折叠组件](https://www.runoob.com/wp-content/uploads/2014/07/simplecollapse_demo.jpg) 正如您在实例中看到的，我们创建了一个可折叠的组件，与折叠面板（accordion）不同，我们没有添加属性 data-parent**。
...
**
[尝试一下 »](https://www.runoob.com/try/tryit.php?filename=bootstrap3-plugin-collapse-method)


结果如下所示：


![折叠（Collapse）插件方法](https://www.runoob.com/wp-content/uploads/2014/07/collapsepluginmethod_demo.jpg)
...
[尝试一下 »](https://www.runoob.com/try/tryit.php?filename=bootstrap3-plugin-collapse-event)


结果如下所示：


![折叠（Collapse）插件事件](https://www.runoob.com/wp-content/uploads/2014/07/collapsepluginevents_demo.jpg)
