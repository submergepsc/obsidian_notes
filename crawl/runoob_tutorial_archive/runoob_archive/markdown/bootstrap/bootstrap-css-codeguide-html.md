...
- Source: https://www.runoob.com/bootstrap/bootstrap-css-codeguide-html.html
...
对于这里用到的术语有疑问吗？请参考 Wikipedia 上的 [层叠样式表 - 语法](https://zh.wikipedia.org/wiki/%E5%B1%82%E5%8F%A0%E6%A0%B7%E5%BC%8F%E8%A1%A8#.E8.AF.AD.E6.B3.95)。
...
完整的属性列表及其排列顺序请参考 [Recess](https://twitter.github.com/recess)。
...
MDN（Mozilla Developer Network）上一篇非常好的关于[shorthand properties](https://developer.mozilla.org/en-US/docs/Web/CSS/Shorthand_properties) 的文章，对于不太熟悉简写属性声明及其行为的用户很有用。
...
参照文档并将这些配置信息添加到项目的 `.editorconfig` 文件中。例如：[Bootstrap 中的 .editorconfig 实例](https://github.com/twbs/bootstrap/blob/master/.editorconfig)。更多信息请参考 [about EditorConfig](http://editorconfig.org)。
	  ...
	  AI 思考中...
			...
			** [Bootstrap HTML编码规范](https://www.runoob.com/bootstrap-html-codeguide.html)
			[Bootstrap 创建一个网页](https://www.runoob.com/bootstrap-make-a-website.html) **
