...
- Source: https://www.runoob.com/flask/flask-orm.html
...
users = User.query.filter(or_(User.username == 'john_doe', User.email == '[email protected]')).all()
```
...
```
	  ...
	  AI 思考中...
			...
			** [Flask 表单处理](https://www.runoob.com/flask-form.html)
