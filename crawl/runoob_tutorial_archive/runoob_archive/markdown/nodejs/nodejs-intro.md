...
- Source: https://www.runoob.com/nodejs/nodejs-intro.html
...
![](https://www.runoob.com/wp-content/uploads/2025/05/PHP-request-handling-cycle.png)
...
![](https://www.runoob.com/wp-content/uploads/2025/05/node.js-request-handling.png)
...
```
# npm 提供了数百万个开源包，几乎任何功能都能找到现成的库
npm search express     # 搜索名为 express 的包
npm install express    # 安装 express 包到当前项目
npm update            # 更新当前项目中所有包到最新兼容版本
```
