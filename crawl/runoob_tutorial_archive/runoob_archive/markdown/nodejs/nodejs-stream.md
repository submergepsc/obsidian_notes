...
- Source: https://www.runoob.com/nodejs/nodejs-stream.html
...
![](https://www.runoob.com/wp-content/uploads/2015/09/stream-nodejs.png)
...
![](https://www.runoob.com/wp-content/uploads/2015/09/bVcla61) 如上面的图片所示，我们把文件比作装水的桶，而水就是文件里的内容，我们用一根管子(pipe)连接两个桶使得水从一个桶流入另一个桶，这样就慢慢的实现了大文件的复制过程。
...
```
	  ...
	  AI 思考中...
			...
			** [Node.js Buffer(缓冲区)](https://www.runoob.com/nodejs-buffer.html)
			[Node.js util 模块](https://www.runoob.com/nodejs-util-module.html) **