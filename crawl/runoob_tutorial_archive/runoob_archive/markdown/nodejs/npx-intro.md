...
- Source: https://www.runoob.com/nodejs/npx-intro.html
...
当你执行 `npx ` 时，它会按照以下逻辑寻找并执行命令：


![](https://www.runoob.com/wp-content/uploads/2026/02/npx-intro-runoob.png)
...
| -p, --package |  | 指定要安装的包。这在需要同时使用多个包时非常有用。 |
| -c |  | 当使用 -p 指定了多个包时，用 -c 来告诉 npx 要执行的具体命令。 |
