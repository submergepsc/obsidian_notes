...
- Source: https://www.runoob.com/nodejs/nodejs-fs.html
...
文件流可以用于高效地读取和写入大文件，而不会一次性将整个文件加载到内存中。
...
可以使用 **fs.stat** 或 **fs.lstat** 获取文件或目录的统计信息。
...
更多内容，请查看官网文件模块描述：[File System](https://nodejs.org/api/fs.html#fs_fs_rename_oldpath_newpath_callback)。
	  ...
	  AI 思考中...
			...
			** [Node.js 常用工具](https://www.runoob.com/nodejs-util.html)
			[Node.js GET/POST请求](https://www.runoob.com/node-js-get-post.html) **