...
- Source: https://www.runoob.com/nodejs/nodejs-install-setup.html

本章节我们将向大家介绍在 Windows、Linux 和 macOS 上安装 Node.js 的方法。


Node.js 安装包及源码下载地址为：[https://nodejs.org/en/download](https://nodejs.org/en/download)。 ![](https://www.runoob.com/wp-content/uploads/2014/03/cdc33d47799ee659a9b25031fea5d7c5.png)


- **Package Manager**：使用系统自带的包管理工具（如 `apt`、`yum`、`brew`）安装。
- 自动管理依赖和更新，适合命令行用户。
...
![](https://www.runoob.com/ www.runoob.com wp-content uploads 2014 03 install-node-exe-on-windows-step21.png)
...
下载后，解压下载包，进入压缩包的 bin 目录，就可以看到已经编译好的 node 和 npm 了，可以直接在命令使用。
	  ...
	  AI 思考中...
			...
			** [Node.js 教程](https://www.runoob.com/nodejs-tutorial.html)
			[Node.js 创建第一个应用](https://www.runoob.com/nodejs-http-server.html) **