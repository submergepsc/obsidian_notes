...
- Source: https://www.runoob.com/nextjs/nextjs-layouts-and-pages.html
...
- **`layout.tsx`**：在这个文件中定义了根布局或页面布局，通常用于设置全局结构（如 `` 和 `**` 标签）。所有子页面都会被嵌套在这个布局内。
...
| 兼容性 | 完全兼容 | Beta 阶段，需手动启用 |
	  ...
	  AI 思考中...
			...
			** [Next.js 安装](https://www.runoob.com/nextjs-install.html)
