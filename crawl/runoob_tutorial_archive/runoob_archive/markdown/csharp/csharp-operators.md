...
**
[运行实例 »](https://www.runoob.com/try/runcode.php?filename=csharp_inc_des_ope&type=cs)
...
| 赋值 | = += -= *= /= %=>>=
	  ...
	  AI 思考中...
			...
			** [C# 常量](https://www.runoob.com/csharp-constants.html)
			[C# 判断](https://www.runoob.com/csharp-decision.html) **