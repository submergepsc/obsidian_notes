...
- Source: https://www.runoob.com/skills/skills-scripts.html
...
# 运行指定版本的 ruff
pipx run '[email protected]' check .
```
...
> 编写一次性命令的建议：固定版本号（如 `npx [[email protected]](https://www.runoob.com/../cdn-cgi/l/email-protection/index.html)`）以确保行为一致；在 SKILL.md 中声明前置条件（如"需要 Node.js 18+"）；当命令变得复杂时，应将其提取到 scripts/ 目录。
...
import * as cheerio from "[email protected]";
...
- 确保脚本可以在目标环境中运行
	  ...
	  AI 思考中...
			...
			** [Skills 描述](https://www.runoob.com/skills-description.html)
			[VS Code 创建与使用 Skill](https://www.runoob.com/vs-code-skill.html) **
