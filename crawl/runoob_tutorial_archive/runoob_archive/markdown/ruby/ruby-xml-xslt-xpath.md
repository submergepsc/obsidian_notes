...
更多内容请查看我们的 [XML 教程](https://www.runoob.com/../xml/xml-tutorial.html)
...
我们可以使用XPath来查看XML ,XPath 是一门在 XML 文档中查找信息的语言(查看：[XPath 教程](https://www.runoob.com/../xpath/xpath-tutorial.html))。
...
- 你可以从 [RAA 知识库](http://raa.ruby-lang.org/project/xslt4r/) 中下载 XSLT4R 。
	  ...
	  AI 思考中...
			...
			** [Ruby Socket 编程](https://www.runoob.com/ruby-socket-programming.html)
			[Ruby Web Service 应用 – SOAP4R](https://www.runoob.com/ruby-web-services.html) **
