...
**
[尝试一下 »](https://www.runoob.com/try/runcode.php?filename=arrobj_demo&type=ruby)
...
[尝试一下 »](https://www.runoob.com/try/runcode.php?filename=arrobj_demo2&type=ruby)
...
[尝试一下 »](https://www.runoob.com/try/runcode.php?filename=arrobj_demo3&type=ruby)
...
| 7 | array 把给定的对象附加到数组的末尾。该表达式返回数组本身，所以几个附加可以连在一起。 |
...
```
	  ...
	  AI 思考中...
			...
			** [Ruby 字符串（String）](https://www.runoob.com/ruby-string.html)
			[Ruby 哈希（Hash）](https://www.runoob.com/ruby-hash.html) **
