...
**
[尝试一下 »](https://www.runoob.com/try/runcode.php?filename=regex_demo&type=ruby)
...
**
[尝试一下 »](https://www.runoob.com/try/runcode.php?filename=regex_demo2&type=ruby)
...
[尝试一下 »](https://www.runoob.com/try/runcode.php?filename=regex_demo3&type=ruby)
...
```
	  ...
	  AI 思考中...
			...
			** [Ruby 面向对象](https://www.runoob.com/ruby-object-oriented.html)
			[Ruby 数据库访问 – DBI 教程](https://www.runoob.com/ruby-database-access.html) **
