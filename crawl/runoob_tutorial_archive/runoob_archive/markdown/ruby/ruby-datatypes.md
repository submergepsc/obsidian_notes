...
**
[尝试一下 »](https://www.runoob.com/try/runcode.php?filename=string_demo&type=ruby)
...
如需了解更多有关 Ruby 字符串的细节，请查看 [Ruby 字符串（String）](https://www.runoob.com/ruby-string.html)。
...
[尝试一下 »](https://www.runoob.com/try/runcode.php?filename=hash_demo&type=ruby)
...
如需了解更多有关 Ruby 哈希的细节，请查看 [Ruby 哈希（Hash）](https://www.runoob.com/ruby-hash.html)。
...
[尝试一下 »](https://www.runoob.com/try/runcode.php?filename=range_demo&type=ruby)
...
如需了解更多有关 Ruby 范围的细节，请查看 [Ruby 范围（Range）](https://www.runoob.com/ruby-range.html)。
	  ...
	  AI 思考中...
			...
			** [Ruby 多线程](https://www.runoob.com/ruby-multithreading.html)
			[Ruby JSON](https://www.runoob.com/ruby-json.html) **
