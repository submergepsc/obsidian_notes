...
为*集合*中的每个元素执行 *code*。在这里，集合可以是数组或哈希。
...
**
[尝试一下 »](https://www.runoob.com/try/runcode.php?filename=iterate_demo&type=ruby)
...
**
[尝试一下 »](https://www.runoob.com/try/runcode.php?filename=iterate_demo2&type=ruby)
...
[尝试一下 »](https://www.runoob.com/try/runcode.php?filename=iterate_demo3&type=ruby)
...
```
	  ...
	  AI 思考中...
			...
			** [Ruby 范围（Range）](https://www.runoob.com/ruby-range.html)
