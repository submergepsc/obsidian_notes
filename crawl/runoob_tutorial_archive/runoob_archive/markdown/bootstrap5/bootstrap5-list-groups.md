...
- Source: https://www.runoob.com/bootstrap5/bootstrap5-list-groups.html

Bootstrap 5 列表组（List Group） 是一种用于展示一系列项目或内容的组件，通常用于展示导航、标签、菜单或其他类似的列表形式。


列表组组件提供了一个灵活的方式来展示有序或无序的内容，可以自定义每个项目的样式、交互和布局。


### 基本结构

Bootstrap 5 列表组由以下几部分组成：

- **`.list-group`**：用于包裹整个列表的容器。
- **`.list-group-item`**：每个列表项，通常包含文本、链接或其他内容。
- **`.list-group-item-action`**：使列表项变得可点击，常用于创建可交互的列表。
- **`.list-group-item-primary`** 等：用于为列表项添加不同的背景色或其他样式。


大部分基础列表组都是无序的。


![](https://www.runoob.com/wp-content/uploads/2021/09/0928AA58-F010-494E-9846-ABA2E6501D33.jpg)
...
**[尝试一下 »](https://www.runoob.com/try/try.php?filename=trybs5_list_group)
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=trybs5_list_group_active)
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=trybs5_list_group_disabled)
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=trybs5_list_group_link)
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=trybs5_list_group_flush)
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=trybs5_list_group_horizontal)
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=trybs5_list_group_context)
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=trybs5_list_group_context_links)
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=trybs5_list_group_example)
	  ...
	  AI 思考中...
			...
			** [Bootstrap5 分页](https://www.runoob.com/bootstrap5-pagination.html)
