...
- Source: https://www.runoob.com/browsers/browsers-firefox.html
...
![Firefox](https://www.runoob.com/images/pic_firefox_large.jpg)
...
[下载 Firefox](http://www.mozilla.org/products/firefox/)
...
下表是 [浏览器统计信息](https://www.runoob.com/browsers-stats.html) 中关于 Firefox 使用情况的细节：
...
- **实现单击播放 - **为了防止弱势插件版本在未经过用户允许的情况下运行/li> **为页面检查器中的 HTML/DOM 增加新的标记面板**
...
- **支持 SPDY 网络协议 v3**
- **WebGL 增强功能**
- **HTML5 - 支持  中的 media 属性**
- **HTML5 - 支持  和  中的 played 属性**
...
[Firefox 的支持站点](http://support.mozilla.com)** Firefox 的支持站点包括了可搜索知识库、下载中心、产品 FAQ 以及辅助支持目录。
	  ...
	  AI 思考中...
			...
			** [Internet Explorer 浏览器](https://www.runoob.com/browsers-explorer.html)
			[Google Chrome 浏览器](https://www.runoob.com/browsers-chrome.html) **
