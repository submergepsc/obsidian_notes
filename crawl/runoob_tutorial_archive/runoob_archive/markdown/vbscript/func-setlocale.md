...
- Source: https://www.runoob.com/vbscript/func-setlocale.html
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=vbdemo_setlocale_func)


## 实例 2（仅适用于 IE）


SetLocale 函数还*返回*之前的 ID：
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=vbdemo_setlocale_func2)
...
[![VBScript 参考手册](https://www.runoob.com/images/up.gif) 完整的 VBScript 参考手册](https://www.runoob.com/vbscript-ref-functions.html)
	  ...
	  AI 思考中...
			...
			** [VBScript ScriptEngine, ScriptEngineBuildVersion, ScriptEngineMajorVersion, ScriptEngineMinorVersion 函数](https://www.runoob.com/func-scriptengine.html)
