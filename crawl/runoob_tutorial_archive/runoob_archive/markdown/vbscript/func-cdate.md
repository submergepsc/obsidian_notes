...
- Source: https://www.runoob.com/vbscript/func-cdate.html
...
CDate 函数把有效的日期和时间表达式转换为日期（Date）类型，并返回结果。p> **提示：**请使用 IsDate 函数来判断 date 是否可被转换为日期或时间。
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=vbdemo_cdate)
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=vbdemo_cdate2)
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=vbdemo_cdate3)
