...
- Source: https://www.runoob.com/codex/codex-subagents.html
...
![](https://www.runoob.com/wp-content/uploads/2026/04/app-multitask.webp) - 将大型任务分解为可管理的部分 - 并行处理多个独立任务 - 为不同类型的任务配置专门的代理 - 提高处理大型项目的效率 **子代理特别适合需要同时处理多个文件或多个独立任务的场景。 --- ## 配置子代理 ### 基础配置 ## 配置子代理
```
# 启用多代理功能
[features]
multi_agent = true
...
![Codex 子代理架构](https://www.runoob.com/images/subagent-architecture.svg)
图：Codex 子代理架构
...
使用 /agents status 查看代理状态，查看它们的输出日志来定位问题。
	  ...
	  AI 思考中...
			...
			** [Codex CLI 提示词技巧](https://www.runoob.com/codex-cli-prompting.html)
			[Codex CLI 模型选择](https://www.runoob.com/codex-cli-models.html) **
...
**站点信息**
      ...
      : · [意见反馈](https://www.runoob.com/cdn-cgi/l/email-protection#3f5e5b5256517f4d4a5150505d115c5052)
