...
- Source: https://www.runoob.com/xslfo/obj-list-item-body.html
...
## 定义和用法
 ...
 对象包含了 list-item 的内容/主体 - 通常是一个或多个  对象。
...
[![XSL-FO 参考手册](https://www.runoob.com/images/up.gif) XSL-FO 参考手册](https://www.runoob.com/xslfo-reference.html)
	  ...
	  AI 思考中...
			...
			** [XSL-FO list-item 对象](https://www.runoob.com/obj-list-item.html)
			[XSL-FO list-item-label 对象](https://www.runoob.com/obj-list-item-label.html) **
