...
- Source: https://www.runoob.com/xslfo/obj-multi-toggle.html
...
The  对象用于当对象被激活时（如：单击），创建一个域，并从一个  切换到另一个 。


"switch-to" 属性通常是匹配要切换到的  的 "case-name" 属性。
...
[![XSL-FO 参考手册](https://www.runoob.com/images/up.gif) XSL-FO 参考手册](https://www.runoob.com/xslfo-reference.html)
	  ...
	  AI 思考中...
			...
			** [XSL-FO multi-switch 对象](https://www.runoob.com/obj-multi-switch.html)
			[XSL-FO page-number 对象](https://www.runoob.com/obj-page-number.html) **
