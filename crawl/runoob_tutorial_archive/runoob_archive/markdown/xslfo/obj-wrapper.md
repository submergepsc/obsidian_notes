...
- Source: https://www.runoob.com/xslfo/obj-wrapper.html
...
## 定义和用法
 ...
 对象为一组 XSL-FO 对象规定 inherited[继承] 属性。


 仅能包含子类对象（该子类对象必须是其父类对象中所允许使用的子类对象）。
...
[![XSL-FO 参考手册](https://www.runoob.com/images/up.gif) XSL-FO 参考手册](https://www.runoob.com/xslfo-reference.html)
	  ...
	  AI 思考中...
			...
			** [XSL-FO title 对象](https://www.runoob.com/obj-title.html)
			[XSL-FO 参考手册](https://www.runoob.com/xslfo-reference.html) **
