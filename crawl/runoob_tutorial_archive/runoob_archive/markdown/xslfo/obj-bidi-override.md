...
- Source: https://www.runoob.com/xslfo/obj-bidi-override.html
...
## 定义和用法
 ...
 对象用于为混合语言文档中的不同脚本重写默认 Unicode BIDI 的方向。
...
[![XSL-FO 参考手册](https://www.runoob.com/images/up.gif) XSL-FO 参考手册](https://www.runoob.com/xslfo-reference.html)
	  ...
	  AI 思考中...
			...
			** [XSL-FO basic-link 对象](https://www.runoob.com/obj-basic-link.html)
			[XSL-FO block 对象](https://www.runoob.com/obj-block.html) **
