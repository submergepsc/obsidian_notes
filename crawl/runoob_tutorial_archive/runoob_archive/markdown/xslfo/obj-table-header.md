...
- Source: https://www.runoob.com/xslfo/obj-table-header.html
...
<fo:table-footer>
  ...
  <fo:table-cell>
    ...
    <fo:block font-weight="bold">Some text</fo:block>
...
[![XSL-FO 参考手册](https://www.runoob.com/images/up.gif) XSL-FO 参考手册](https://www.runoob.com/xslfo-reference.html)
	  ...
	  AI 思考中...
			...
			** [XSL-FO table-footer 对象](https://www.runoob.com/obj-table-footer.html)
			[XSL-FO table-row 对象](https://www.runoob.com/obj-table-row.html) **
