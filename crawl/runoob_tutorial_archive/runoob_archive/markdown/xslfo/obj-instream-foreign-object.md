...
- Source: https://www.runoob.com/xslfo/obj-instream-foreign-object.html
...
## 定义和用法
 ...
 对象用于内联图形或 "generic" 类对象。在其中，对象的数据以  的后代形式存在。通常情况下，是作为一个非 XSL 命名空间中的 XML 元素子树（一个常见的格式是 SVG）存储于其内部。
...
[![XSL-FO 参考手册](https://www.runoob.com/images/up.gif) XSL-FO 参考手册](https://www.runoob.com/xslfo-reference.html)
	  ...
	  AI 思考中...
			...
			** [XSL-FO inline-container 对象](https://www.runoob.com/obj-inline-container.html)
