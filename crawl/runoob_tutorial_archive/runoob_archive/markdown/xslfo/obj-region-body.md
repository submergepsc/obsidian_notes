...
- Source: https://www.runoob.com/xslfo/obj-region-body.html
...
**提示：**为了在 region-body 区提供多个列， 需要把 column-count 属性设置为大于 1！/p> **注意：**如果 overflow 属性的值为 "scroll"，则您不能把 column-count 属性设置为大于 1！
...
[![XSL-FO 参考手册](https://www.runoob.com/images/up.gif) XSL-FO 参考手册](https://www.runoob.com/xslfo-reference.html)
	  ...
	  AI 思考中...
			...
			** [XSL-FO region-before 对象](https://www.runoob.com/obj-region-before.html)
			[XSL-FO region-end 对象](https://www.runoob.com/obj-region-end.html) **
