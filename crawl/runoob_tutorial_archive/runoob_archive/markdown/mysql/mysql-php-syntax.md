...
- Source: https://www.runoob.com/mysql/mysql-php-syntax.html
...
如果你想了解 MySQL 在 PHP 中的应用，可以访问我们的 [PHP 中使用 MySQL 介绍](https://www.runoob.com/../php/php-mysql-intro.html)。
...
```
	  ...
	  AI 思考中...
			...
			** [MySQL 管理](https://www.runoob.com/mysql-administration.html)
