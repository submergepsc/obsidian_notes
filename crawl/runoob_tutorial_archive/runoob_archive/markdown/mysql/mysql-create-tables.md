...
- Source: https://www.runoob.com/mysql/mysql-create-tables.html
...
--- ## 通过命令提示符创建表 通过** mysql>** 命令窗口可以很简单的创建 MySQL 数据表。
...
![](https://www.runoob.com/wp-content/uploads/2014/03/83B74D96-5A71-40DF-86CB-10E1A434B973.jpg)
	  ...
	  AI 思考中...
			...
			** [MySQL 数据类型](https://www.runoob.com/mysql-data-types.html)
			[MySQL 删除数据表](https://www.runoob.com/mysql-drop-tables.html) **