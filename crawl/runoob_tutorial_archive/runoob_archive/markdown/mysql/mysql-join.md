...
- Source: https://www.runoob.com/mysql/mysql-join.html
...
本章节使用的数据库结构及数据下载：[runoob-mysql-join-test.sql](https://static.jyshare.com/download/runoob-mysql-join-test.sql)。
...
```
	  ...
	  AI 思考中...
			...
			** [MySQL ORDER BY(排序) 语句](https://www.runoob.com/mysql-order-by.html)
