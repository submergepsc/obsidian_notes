...
- Source: https://www.runoob.com/mysql/mysql-union-operation.html
...
下面的 SQL 语句使用 UNION ALL 从 "Websites" 和 "apps" 表中选取所有的**中国(CN)的数据（也有重复的值）：
...
```
	  ...
	  AI 思考中...
			...
			** [MySQL GROUP BY 语句](https://www.runoob.com/mysql-group-by-statement.html)
			[MySQL 函数](https://www.runoob.com/mysql-functions.html) **