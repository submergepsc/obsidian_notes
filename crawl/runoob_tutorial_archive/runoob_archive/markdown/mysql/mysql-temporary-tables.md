...
- Source: https://www.runoob.com/mysql/mysql-temporary-tables.html
...
以下展示了使用 MySQL 临时表的简单实例，以下的 SQL 代码可以适用于PHP脚本的 mysql_query() 函数。
...
```
	  ...
	  AI 思考中...
			...
			** [MySQL 索引](https://www.runoob.com/mysql-index.html)
