...
- Source: https://www.runoob.com/mysql/mysql-database-export.html
...
如果完整备份数据库，则无需使用特定的表名称。 如果你需要将备份的数据库导入到MySQL服务器中，可以使用以下命令，使用以下命令你需要确认数据库已经创建：
...
以上命令中使用了管道来将导出的数据导入到指定的远程主机上。
	  ...
	  AI 思考中...
			...
			** [MySQL 及 SQL 注入](https://www.runoob.com/mysql-sql-injection.html)
			[MySQL 导入数据](https://www.runoob.com/mysql-database-import.html) **