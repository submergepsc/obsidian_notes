...
- Source: https://www.runoob.com/bootstrap4/bootstrap4-utilities.html
...
> breakpoints 指的是屏幕宽度: xs (=576px), md (>=768px), lg (>=992px), xl (>=1200px)。
...
| .ml-# / ml-*-# | margin left | 尝试一下 |
| .mr-# / mr-*-# | margin right | 尝试一下 |
...
| .pl-# / pl-*-# | padding left | 尝试一下 |
| .pr-# / pr-*-# | padding right | 尝试一下 |
