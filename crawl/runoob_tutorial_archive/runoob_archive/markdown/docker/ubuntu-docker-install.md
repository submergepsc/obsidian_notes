...
- Xenial 16.04 (LTS) - Bionic 18.04 (LTS) - Cosmic 18.10 - Disco 19.04 - 其他更新的版本…… Docker Engine - Community 支持上 x86_64（或 amd64）armhf，arm64，s390x （IBM Z），和 ppc64le（IBM的Power）架构。
...
```
	  ...
	  AI 思考中...
			...
			** [Docker Hello World](https://www.runoob.com/docker-hello-world.html)
