...
- Source: https://www.runoob.com/cssref/sel-link.html
...
**[尝试一下 »](https://www.runoob.com/try/try.php?filename=trycss_sel_link)
...
**提示:** 使用 [:visited](https://www.runoob.com/sel-visited.html) 选择器设置访问过的页面链接的样式，[:hover](https://www.runoob.com/sel-hover.html)选择器当有鼠标悬停在其上的链接样式，[:active](https://www.runoob.com/sel-active.html) 选择器设置当你点击链接时的样式。
...
CSS 教程: [CSS Pseudo classes](https://www.runoob.com/../css/css-pseudo-classes.html)
...
[![CSS完整选择器](https://www.runoob.com/images/up.gif)完整CSS选择器参考手册](https://www.runoob.com/css-selectors.html)
	  ...
	  AI 思考中...
			...
			** [CSS [attribute|=value] 选择器](https://www.runoob.com/sel-attribute-value-lang.html)
