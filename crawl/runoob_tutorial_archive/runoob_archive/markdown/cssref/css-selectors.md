...
- Source: https://www.runoob.com/cssref/css-selectors.html
...
| * | * | 选择所有元素 | 2 |
| element | p | 选择所有元素 | 1 |
| element,element | div,p | 选择所有元素和 元素 | 1 |
...
| :is | :is | 接收任何数量的选择器作为参数，并且返回这些选择器匹配的元素的并集。 | 3 |
	  ...
	  AI 思考中...
			...
			** [CSS 参考手册](https://www.runoob.com/css-reference.html)
			[CSS 听觉参考手册](https://www.runoob.com/css-ref-aural.html) **