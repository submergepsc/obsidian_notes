...
- Source: https://www.runoob.com/cssref/css3-pr-box-sizing.html
...
| 属性 |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| box-sizing | 10.04.0 -webkit- | 8.0 | 29.02.0 -moz- | 5.13.2 -webkit- | 9.5 |
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=trycss3_box-sizing2)
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=trycss3_box-sizing3)
...
CSS3 教程: [CSS3 用户界面](https://www.runoob.com/../css3/css3-user-interface.html)
	  ...
	  AI 思考中...
			...
			** [CSS3 box-pack 属性](https://www.runoob.com/css3-pr-box-pack.html)
			[CSS3 box-shadow 属性](https://www.runoob.com/css3-pr-box-shadow.html) **