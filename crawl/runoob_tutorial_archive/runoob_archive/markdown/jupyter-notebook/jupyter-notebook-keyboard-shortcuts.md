...
- Source: https://www.runoob.com/jupyter-notebook/jupyter-notebook-keyboard-shortcuts.html
...
![](https://www.runoob.com/wp-content/uploads/2026/04/6d0cd582-e23c-40ea-b94d-cde00b1da11f.png)


![](https://www.runoob.com/wp-content/uploads/2026/04/552e81f8-c81c-48ee-9b45-a8963d8f0ee7.png)
...
| --- | --- | --- | --- |
| 命令模式（Command Mode） | 蓝色 | 按 Esc 或点击 Cell 左侧空白区 | 对 Cell 进行管理操作（新增、删除、移动等） |
| 编辑模式（Edit Mode） | 绿色 | 按 Enter 或双击 Cell 内部 | 在 Cell 内部编写和修改代码或文本 |
