...
- Source: https://www.runoob.com/html/fitten-code-html.html
...
![](https://static.jyshare.com/images/re/fittencode/202509/html/image1.png)
...
![IMG_256](https://static.jyshare.com/images/re/fittencode/202509/html/image2.png)


在搜索框中搜索关键字 Fitten Code：


![IMG_256](https://static.jyshare.com/images/re/fittencode/202509/html/image3.png)


在搜索结果中点击 Install：


![IMG_256](https://static.jyshare.com/images/re/fittencode/202509/html/image4.png)


登录注册后即可开始使用：


![IMG_256](https://static.jyshare.com/images/re/fittencode/202509/html/image5.jpg)
...
![](https://static.jyshare.com/images/re/fittencode/202509/html/image6.png)


按下 `tab` 键接受所有补全建议：


![](https://static.jyshare.com/images/re/fittencode/202509/html/image7.png)


按下 `Ctrl + →` 键(mac 系统为 `Command + →`)接收单个词补全建议：


![](https://static.jyshare.com/images/re/fittencode/202509/html/image8.png)
...
在使用该功能时，用户只需要输入需要完成的开发任务，例如"将顶部导航栏的颜色改为黑色"、"修改按钮将其改为下拉框组件"**等，智能体就可以根据任务调用不同工具，例如："读取文件夹"、"读取文件"、"修改文件"等逐步完成开发任务。


可以使用此 Agent 模式，让其逐渐优化文件夹和代码结构，提高项目的可维护性。


![](https://static.jyshare.com/images/re/fittencode/202509/html/agent基础用法.jpg)


在 Agent 执行的过程中，涉及到创建和修改文件、执行终端命令的操作时，点击"同意"或"拒绝"即可。


![](https://static.jyshare.com/images/re/fittencode/202509/html/同意或拒绝.jpg)
...
在开发程序时，用户项目往往有着各种各样的要求，例如 `html文件命名统一采用大驼峰`、`必须使用语义化标签，禁止滥用div标签`、`必须在  中设置正确的  和 ` 等等要求，如果 Agent 不知道用户项目定制化的特殊要求，用户可以将这些要求写入规则文件，进而增强 Agent 的代码生成规范和行为规范。
...
![](https://static.jyshare.com/images/re/fittencode/202509/html/添加rules方法.png)
...
![](https://static.jyshare.com/images/re/fittencode/202509/html/chat模式.jpg)


当用户选中文件中的代码段再进行对话时，Fitten Code 会自动引用用户所选中的代码段，此时可直接针对该代码段进行问询等操作：


![](https://static.jyshare.com/images/re/fittencode/202509/html/chat模式选中代码.png)
...
![IMG_277](https://static.jyshare.com/images/re/fittencode/202509/html/右键菜单.png)
...
![IMG_277](https://static.jyshare.com/images/re/fittencode/202509/html/image26.png)


然后在设置页面点击右上角 \"打开设置(JSON)\":


![IMG_278](https://static.jyshare.com/images/re/fittencode/202509/html/image27.png)
...
![IMG_279](https://static.jyshare.com/images/re/fittencode/202509/html/image28.png)
...
- [Vim](https://code.fittentech.com/tutor_vim_zh#1)
	  ...
	  AI 思考中...
			...
			* [HTML 标签简写及全称](https://www.runoob.com/html-tag-name.html)
			[HTML5 Web IndexedDB 数据库](https://www.runoob.com/html5-web-api-indexeddb.html) **
