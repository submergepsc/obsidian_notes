...
- Source: https://www.runoob.com/html/html5-canvas.html
...
canvas 元素本身是没有绘图能力的。所有的绘制工作必须在 JavaScript 内部完成： ## 实例
```html
...
```
 [尝试一下 »](https://www.runoob.com/try/try.php?filename=tryhtml5_canvas_first) 实例解析:**
...
![The Scream](https://www.runoob.com/images/img_the_scream.jpg)
