...
- Source: https://www.runoob.com/html/html5-web-api-indexeddb.html
...
request.onsuccess = function(event) {
  ...
  objectStore.add({ id: 2, name: 'Jane Doe', email: '[email protected]' });
  ...
  var updatedCustomer = { id: 1, name: 'John Smith', email: '[email protected]' };
...
- IndexedDB 非常适合需要存储大量结构化数据的应用程序，尤其是那些希望支持离线模式或处理复杂查询的 Web 应用。
	  ...
	  AI 思考中...
			...
			** [HTML AI 编程助手](https://www.runoob.com/fitten-code-html.html)
