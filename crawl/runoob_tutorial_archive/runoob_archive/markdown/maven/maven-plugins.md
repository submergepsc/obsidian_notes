...
- Source: https://www.runoob.com/maven/maven-plugins.html
...
![](https://www.runoob.com/wp-content/uploads/2018/09/mavenplugins.webp)
...
- `maven-compiler-plugin`：`compile`：编译主代码
- `testCompile`：编译测试代码
...
| maven-failsafe-plugin | 运行集成测试 | integration-test |
...
我们已经在我们的例子中大量使用了 **maven-antrun-plugin** 来输出数据到控制台上。请查看 [**Maven - 构建配置文件**](https://www.runoob.com/maven-build-profiles.html) 章节。让我们用一种更好的方式理解这部分内容，在 C:\MVN\project 目录下创建一个 pom.xml 文件。
