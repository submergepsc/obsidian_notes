...
- Source: https://www.runoob.com/react/react-component-api.html
...
React 组件的生命周期方法分为三个主要阶段：挂载、更新和卸载，详细说明参见：[React 组件的生命周期](https://www.runoob.com/react-component-life-cycle.html) 。
...
```
 ...
 [尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_props_setstate)
...
实例中通过点击 h2 标签来使得点击计数器加 1。
	  ...
	  AI 思考中...
			...
			** [React Props](https://www.runoob.com/react-props.html)
			[React 组件生命周期](https://www.runoob.com/react-component-life-cycle.html) **