...
- Source: https://www.runoob.com/react/react-forms-events.html
...
** [尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_form)
...
** [尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_form2)
...
```
 ...
 [尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_select)
...
```
 ...
 [尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_form3)
...
```
 ...
 [尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_click)
...
```
 ...
 [尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_click2)
	  ...
	  AI 思考中...
			...
			** [React AJAX](https://www.runoob.com/react-ajax.html)
			[React Refs](https://www.runoob.com/react-refs.html) **