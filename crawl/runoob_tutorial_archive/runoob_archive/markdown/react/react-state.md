...
- Source: https://www.runoob.com/react/react-state.html
...
** [尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_state)
...
** [尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_state2)
...
```
 ...
 [尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_state3)
...
```
 ...
 [尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_state4)
...
我们可以在有状态组件中使用无状态组件，也可以在无状态组件中使用有状态组件。
	  ...
	  AI 思考中...
			...
			** [React 组件](https://www.runoob.com/react-components.html)
			[React Props](https://www.runoob.com/react-props.html) **