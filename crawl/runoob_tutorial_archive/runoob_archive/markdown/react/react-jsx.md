...
- Source: https://www.runoob.com/react/react-jsx.html
...
**
[尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_jsx)
...
** [尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_nested)
...
```
 ...
 [尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_seprate_file)
...
** [尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_expression)
...
** [尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_expression2)
...
```
 ...
 [尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_inline_style)
...
```
 ...
 [尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_comment)
...
```
 ...
 [尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_arr)
	  ...
	  AI 思考中...
			...
			** [React 安装(NPM)](https://www.runoob.com/react-install.html)
			[React 组件](https://www.runoob.com/react-components.html) **