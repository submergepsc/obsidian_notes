...
- Source: https://www.runoob.com/react/react-props.html
...
** [尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_component2)
...
```
 ...
 [尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_props_default)
...
```
 ...
 [尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_props_state)
...
** [尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_proptypes2)
...
```
 ...
 [尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_proptypes)
...
```
	  ...
	  AI 思考中...
			...
			** [React 组件状态(State)](https://www.runoob.com/react-state.html)
