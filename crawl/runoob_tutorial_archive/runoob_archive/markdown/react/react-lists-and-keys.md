...
- Source: https://www.runoob.com/react/react-lists-and-keys.html
...
** [尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_lists)
...
```
 ...
 [尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_lists2)
...
比方说，如果你提取出一个 ListItem 组件，你应该把 key 保存在数组中的这个 **** 元素上，而不是放在 ListItem 组件中的 ** 元素上。
...
```
 ...
 [尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_keys)
...
```
 ...
 [尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_keys2)
...
```
 ...
 [尝试一下 »](https://www.runoob.com/try/try.php?filename=try_react_keys3)
...
这么做有时可以使你的代码更清晰，但有时这种风格也会被滥用。就像在 JavaScript 中一样，何时需要为了可读性提取出一个变量，这完全取决于你。但请记住，如果一个 map() 嵌套了太多层级，那你就可以提取出组件。
	  ...
	  AI 思考中...
			...
			** [React 条件渲染](https://www.runoob.com/react-conditional-rendering.html)
