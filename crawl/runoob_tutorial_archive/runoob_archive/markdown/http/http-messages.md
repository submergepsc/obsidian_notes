...
- Source: https://www.runoob.com/http/http-messages.html
...
- **请求行**（Request Line）： **方法**：如 GET、POST、PUT、DELETE等，指定要执行的操作。
...
- **状态行**（Status Line）： **HTTP 版本**：与请求消息中的版本相匹配。
