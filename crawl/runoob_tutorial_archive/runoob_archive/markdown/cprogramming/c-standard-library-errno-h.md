...
`` 是 C 标准库中的一个头文件，提供了一种在程序中报告和处理错误的机制。这个头文件定义了宏和变量，用于指示和描述运行时错误的类型。
...
总之，`` 提供了一种标准化的方式来报告和处理程序中的错误，使得错误处理代码更为一致和可维护。
...
| 3 | ERANGE Range Error这个宏表示一个范围错误，它在输入参数超出数学函数定义的范围时发生，errno 被设置为 ERANGE。 |
	  ...
	  AI 思考中...
			...
			** [C 标准库 – ](https://www.runoob.com/c-standard-library-ctype-h.html)
