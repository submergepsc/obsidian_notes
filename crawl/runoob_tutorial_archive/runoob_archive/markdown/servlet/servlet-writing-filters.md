...
- Source: https://www.runoob.com/servlet/servlet-writing-filters.html
...
![](https://www.runoob.com/wp-content/uploads/2014/07/sfilter.jpg)
...
- ``指定一个过滤器。 ``用于为过滤器指定一个名字，该元素的内容不能为空。
- ``元素用于指定过滤器的完整的限定类名。
