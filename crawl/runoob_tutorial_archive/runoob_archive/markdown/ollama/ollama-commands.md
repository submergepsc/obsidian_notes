...
- Source: https://www.runoob.com/ollama/ollama-commands.html
...
run serverless****当 `ollama run` 时会自动拉起后台服务，不需单独执行。
...
REST 端点（默认 [http://localhost:11434/api）：](http://localhost:11434/api）：)
