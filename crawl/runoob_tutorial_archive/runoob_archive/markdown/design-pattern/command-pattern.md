...
命令模式（Command Pattern）是一种数据驱动的设计模式，它属于行为型模式。 命令模式将一个请求封装为一个对象，从而使你可以用不同的请求对客户进行参数化，对请求排队或记录请求日志，以及支持可撤销的操作。
...
```
	  ...
	  AI 思考中...
			...
			** [责任链模式](https://www.runoob.com/chain-of-responsibility-pattern.html)
			[解释器模式](https://www.runoob.com/interpreter-pattern.html) **