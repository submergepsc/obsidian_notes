...
![外观模式的 UML 图](https://www.runoob.com/wp-content/uploads/2014/08/20241015-facade-facade.svg)
...
```
	  ...
	  AI 思考中...
			...
			** [装饰器模式](https://www.runoob.com/decorator-pattern.html)
			[享元模式](https://www.runoob.com/flyweight-pattern.html) **