...
- Source: https://www.runoob.com/design-pattern/null-object-pattern.html
...
```
	  ...
	  AI 思考中...
			...
			** [状态模式](https://www.runoob.com/state-pattern.html)
			[策略模式](https://www.runoob.com/strategy-pattern.html) **