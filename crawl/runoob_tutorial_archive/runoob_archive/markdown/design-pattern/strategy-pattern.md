...
- Source: https://www.runoob.com/design-pattern/strategy-pattern.html
...
```
	  ...
	  AI 思考中...
			...
			** [空对象模式](https://www.runoob.com/null-object-pattern.html)
			[模板模式](https://www.runoob.com/template-pattern.html) **