...
- Source: https://www.runoob.com/design-pattern/mediator-pattern.html
...
```
	  ...
	  AI 思考中...
			...
			** [迭代器模式](https://www.runoob.com/iterator-pattern.html)
			[备忘录模式](https://www.runoob.com/memento-pattern.html) **