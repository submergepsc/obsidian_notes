...
- Source: https://www.runoob.com/django/django-django-admin.html
...
| 参数 | 作用 | 示例 |
| --- | --- | --- |
|  | 必填，项目名称（会生成同名目录） | django-admin startproject mysite |
...
| 参数 | 作用 | 示例 |
| --- | --- | --- |
|  | 必填，应用名称（会生成 models.py, views.py 等） | django-admin startapp blog |
...
| collectstatic | 收集静态文件（生产环境部署） | python manage.py collectstatic |
	  ...
	  AI 思考中...
			...
			** [Django 视图 – FBV 与 CBV](https://www.runoob.com/django-views-fbv-cbv.html)
			[Django 项目结构解析](https://www.runoob.com/django-project-intro.html) **
