...
- Source: https://www.runoob.com/django/django-middleware.html
...
![](https://www.runoob.com/wp-content/uploads/2020/05/Django-md_2.png)
...
![](https://www.runoob.com/wp-content/uploads/2020/05/Django-md_5.png)
...
![](https://www.runoob.com/wp-content/uploads/2020/05/Django-md_1.gif)
...
![](https://www.runoob.com/wp-content/uploads/2020/05/md-sssss-1.png)
...
- 当最后一个中间件的 process_request 到达路由关系映射之后，返回到第一个中间件 process_view，然后依次往下，到达视图函数。 ## 实例
```python
class MD1(MiddlewareMixin):
    def process_request(self, request):
        print("md1  process_request 方法。", id(request)) #在视图之前执行
...
```
 ![](https://www.runoob.com/wp-content/uploads/2020/05/Django-md_2.gif) ![](https://www.runoob.com/wp-content/uploads/2020/05/md-32rdf.png) ### process_exception process_exception 方法如下：
```
process_exception(request, exception)
```
 参数说明： request 是 HttpRequest 对象。
...
![](https://www.runoob.com/wp-content/uploads/2020/05/Django-md_3.gif)
	  ...
	  AI 思考中...
			...
			** [Django cookie 与 session](https://www.runoob.com/django-cookie-session.html)
			[Django 视图 – FBV 与 CBV](https://www.runoob.com/django-views-fbv-cbv.html) **
