...
- Source: https://www.runoob.com/php/php-string.html
...
**[运行实例 »](https://www.runoob.com/try/runcode.php?filename=demo_string_echo&type=php)
...
**[运行实例 »](https://www.runoob.com/try/runcode.php?filename=demo_string_length&type=php)
...
**[运行实例 »](https://www.runoob.com/try/runcode.php?filename=demo_string_pos&type=php)
...
如需查看所有字符串函数的完整参考手册，请访问我们的 [PHP String 参考手册](https://www.runoob.com/php-ref-string.html)。
...
该参考手册提供了每个函数的简要描述和应用实例！
	  ...
	  AI 思考中...
			...
			** [PHP 变量](https://www.runoob.com/php-variables.html)
			[PHP 运算符](https://www.runoob.com/php-operators.html) **