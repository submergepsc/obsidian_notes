...
- Source: https://www.runoob.com/php/func-array-diff-uassoc.html
...
比较两个数组的**键名和键值**（使用用户自定义函数比较键名），并返回差集：


```php
<?phpfunction myfunction($a,$b){if ($a===$b)  {
	return 0;  }  return ($a>$b)?1:-1;}
	$a1=array("a"=>"red","b"=>"green","c"=>"blue");$a2=array("d"=>"red","b"=>"green","e"=>"blue");$result=array_diff_uassoc($a1,$a2,"myfunction");print_r($result);
	?>
```


**[运行实例 »](https://www.runoob.com/try/showphp.php?filename=demo_func_array_diff_uassoc)
...
**[运行实例 »](https://www.runoob.com/try/showphp.php?filename=demo_func_array_diff_uassoc2)
...
[![PHP Array 参考手册](https://www.runoob.com/images/up.gif)完整的 PHP Array 参考手册](https://www.runoob.com/php-ref-array.html)
	  ...
	  AI 思考中...
			...
			** [PHP array_diff_key() 函数](https://www.runoob.com/func-array-diff-key.html)
			[PHP array_diff_ukey() 函数](https://www.runoob.com/func-array-diff-ukey.html) **
