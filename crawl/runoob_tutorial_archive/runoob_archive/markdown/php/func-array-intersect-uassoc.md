...
- Source: https://www.runoob.com/php/func-array-intersect-uassoc.html
...
比较两个数组的**键名和键值**（使用用户自定义函数比较键名），并返回交集：
...
<?php
	...
	$a1=array("a"=>"red","b"=>"green","c"=>"blue");$a2=array("d"=>"red","b"=>"green","e"=>"blue");$result=array_intersect_uassoc($a1,$a2,"myfunction");print_r($result);?>
```


**[运行实例 »](https://www.runoob.com/try/showphp.php?filename=demo_func_array_intersect_uassoc)
...
**[运行实例 »](https://www.runoob.com/try/showphp.php?filename=demo_func_array_intersect_uassoc2)
...
[![PHP Array Reference](https://www.runoob.com/images/up.gif)完整的 PHP Array 参考手册](https://www.runoob.com/php-ref-array.html)
	  ...
	  AI 思考中...
			...
			** [PHP array_intersect_key() 函数](https://www.runoob.com/func-array-intersect-key.html)
			[PHP array_intersect_ukey() 函数](https://www.runoob.com/func-array-intersect-ukey.html) **
