...
- Source: https://www.runoob.com/php/func-array-intersect-key.html
...
```php
<?php
	$a1=array("a"=>"red","b"=>"green","c"=>"blue");$a2=array("a"=>"red","c"=>"blue","d"=>"pink");$result=array_intersect_key($a1,$a2);print_r($result);?>
```


**[运行实例 »](https://www.runoob.com/try/showphp.php?filename=demo_func_array_intersect_key)
...
**[运行实例 »](https://www.runoob.com/try/showphp.php?filename=demo_func_array_intersect_key2)
...
**[运行实例 »](https://www.runoob.com/try/showphp.php?filename=demo_func_array_intersect_key3)
