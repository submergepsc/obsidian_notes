...
- Source: https://www.runoob.com/php/php-namespace.html
...
- 在命名空间内部（例如A\B），对非限定名称的函数调用是在运行时解析的。例如对函数 *foo()* 的调用是这样解析的： 在当前命名空间中查找名为 *A\B\foo()* 的函数
...
- 尝试自动装载类 *A\B\D\E*。
	  ...
	  AI 思考中...
			...
			** [PHP 魔术常量](https://www.runoob.com/php-magic-constant.html)
			[PHP PDO](https://www.runoob.com/php-pdo.html) **