...
- Source: https://www.runoob.com/php/func-array-merge.html
...
**[运行实例 »](https://www.runoob.com/try/showphp.php?filename=demo_func_array_merge)
...
**提示：**该函数与 [array_merge_recursive()](https://www.runoob.com/func-array-merge-recursive.html) 函数之间的不同是在处理两个或更多个数组元素有相同的键名的情况。array_merge_recursive() 不会进行键名覆盖，而是将多个相同键名的值递归组成一个数组。
...
[运行实例 »](https://www.runoob.com/try/showphp.php?filename=demo_func_array_merge2)
