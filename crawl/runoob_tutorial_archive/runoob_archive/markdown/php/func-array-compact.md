...
- Source: https://www.runoob.com/php/func-array-compact.html
...
$lastname = "Griffin";
$age = "41";
$result = compact("firstname", "lastname", "age");print_r($result);
?>
```


**[运行实例 »](https://www.runoob.com/try/showphp.php?filename=demo_func_compact)
...
[运行实例 »](https://www.runoob.com/try/showphp.php?filename=demo_func_compact2)
...
[![PHP Array Reference](https://www.runoob.com/images/up.gif)完整的 PHP Array 参考手册](https://www.runoob.com/php-ref-array.html)
	  ...
	  AI 思考中...
			...
			** [PHP asort() 函数](https://www.runoob.com/func-array-asort.html)
			[PHP count() 函数](https://www.runoob.com/func-array-count.html) **
