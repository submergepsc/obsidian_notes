...
- Source: https://www.runoob.com/php/func-array-krsort.html
...
**[运行实例 »](https://www.runoob.com/try/showphp.php?filename=demo_func_krsort)
...
提示：**请使用 [ksort()](https://www.runoob.com/func-array-ksort.html) 函数对关联数组按照键名进行升序排序。


**提示：**请使用 [arsort()](https://www.runoob.com/func-array-arsort.html) 函数对关联数组按照键值进行降序排序。
