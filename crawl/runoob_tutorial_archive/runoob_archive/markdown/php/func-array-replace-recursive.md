...
- Source: https://www.runoob.com/php/func-array-replace-recursive.html
...
**[运行实例 »](https://www.runoob.com/try/showphp.php?filename=demo_func_array_replace_recursive)
...
**注释：**如果没有为每个数组指定一个键，该函数的行为将等同于 [array_replace()](https://www.runoob.com/func-array-replace.html) 函数。
...
[运行实例 »](https://www.runoob.com/try/showphp.php?filename=demo_func_array_replace_recursive2)
...
[运行实例 »](https://www.runoob.com/try/showphp.php?filename=demo_func_array_replace_recursive3)
...
[![PHP Array 参考手册](https://www.runoob.com/images/up.gif)完整的 PHP Array 参考手册](https://www.runoob.com/php-ref-array.html)
	  ...
	  AI 思考中...
			...
			** [PHP array_replace() 函数](https://www.runoob.com/func-array-replace.html)
			[PHP 魔术常量](https://www.runoob.com/php-magic-constant.html) **
