...
- Source: https://www.runoob.com/php/func-array-udiff-assoc.html
...
比较两个数组的**键名和键值**（使用内建函数比较键名，使用用户自定义函数比较键值），并返回差集：
...
**[运行实例 »](https://www.runoob.com/try/showphp.php?filename=demo_func_array_udiff_assoc)
...
[![PHP Array Reference](https://www.runoob.com/images/up.gif)完整的 PHP Array 参考手册](https://www.runoob.com/php-ref-array.html)
	  ...
	  AI 思考中...
			...
			** [PHP array_udiff() 函数](https://www.runoob.com/func-array-udiff.html)
