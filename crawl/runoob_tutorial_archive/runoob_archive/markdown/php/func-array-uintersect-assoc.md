...
- Source: https://www.runoob.com/php/func-array-uintersect-assoc.html
...
比较两个数组的**键名和键值**（使用内建函数比较键名，使用用户自定义函数比较键值），并返回交集：
...
**[运行实例 »](https://www.runoob.com/try/showphp.php?filename=demo_func_array_uintersect_assoc)
