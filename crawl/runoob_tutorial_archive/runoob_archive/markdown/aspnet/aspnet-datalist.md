...
- Source: https://www.runoob.com/aspnet/aspnet-datalist.html
...
然后我们在 .aspx 页面中创建一个 DataList 控件。 元素中的内容被首先呈现，并且在输出中仅出现一次，而  元素中的内容会对应 DataSet 中的每条 "record" 重复出现，最后， 元素中的内容在输出中仅出现一次：
...
然后我们添加创建 DataSet 的脚本，并且绑定 mycdcatalog DataSet 到 DataList 控件。然后 使用包含表头的 、包含要显示的数据项的  和包含文本的  来填充 DataList 控件。请注意，可设置 DataList 的 gridlines 属性为 "both" 来显示表格边框：
...
[演示实例 »](https://www.runoob.com/try/showaspx.php?filename=demo_datalist1)
...
[演示实例 »](https://www.runoob.com/try/showaspx.php?filename=demo_datalist2)
...
[演示实例 »](https://www.runoob.com/try/showaspx.php?filename=demo_datalist3)
