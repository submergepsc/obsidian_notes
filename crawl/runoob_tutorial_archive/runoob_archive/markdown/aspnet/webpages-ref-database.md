...
- Source: https://www.runoob.com/aspnet/webpages-ref-database.html
...
| Database.Open(filename) Database.Open(connectionStringName) | 使用 Web.config 文件中的连接字符串打开指定的数据库文件或者指定的数据库。 |
