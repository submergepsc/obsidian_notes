...
- Source: https://www.runoob.com/tailwindcss/tailwindcss-animations.html
...
**[尝试一下 »](https://www.runoob.com/try/try.php?filename=trytailwindcss_animations)
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=trytailwindcss_animations1)
...
**[尝试一下 »](https://www.runoob.com/try/try.php?filename=trytailwindcss_animations2)
...
**[尝试一下 »](https://www.runoob.com/try/try.php?filename=trytailwindcss_animations3)
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=trytailwindcss_animations4)
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=trytailwindcss_animations5)
...
**[尝试一下 »](https://www.runoob.com/try/try.php?filename=trytailwindcss_animations6)
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=trytailwindcss_animations7)


### 4. 自定义动画


在 `tailwind.config.js` 中扩展动画：
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=trytailwindcss_animations8)
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=trytailwindcss_animations9)
...
- **谨慎使用动画**：避免过多动画影响性能
- **硬件加速**：对复杂动画使用 `transform` 和 `opacity`
- **减少重绘**：优先使用 `transform` 和 `opacity` 而非影响布局的属性
- **合理使用 `will-change`**：对已知会变化的元素添加 `will-change` 类
...
**[尝试一下 »](https://www.runoob.com/try/try.php?filename=trytailwindcss_animations10)
