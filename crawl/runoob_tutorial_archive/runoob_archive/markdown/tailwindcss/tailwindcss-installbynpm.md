...
- Source: https://www.runoob.com/tailwindcss/tailwindcss-installbynpm.html
...
**
本章节是 Tailwind CSS 3 的安装方式，，Tailwind CSS 4 安装方式有所改变， 会自动检测 HTML 和 JavaScript 等文件，省去了手动配置内容源的麻烦。

详细内容参见：[Tailwind CSS4 安装](https://www.runoob.com/tailwindcss4-installbynpm.html)。
...
将编译好的 CSS 文件添加到  标签内，然后就可以开始使用 Tailwind 的工具类来为你的内容设置样式了。
...
确保编译后的 CSS 文件被正确引入到  标签中（某些框架可能会自动完成这一步），然后开始在 HTML 中使用 Tailwind CSS 提供的实用类来为内容添加样式。
...
```
	  ...
	  AI 思考中...
			...
			** [Tailwind CSS 安装(CDN)](https://www.runoob.com/tailwindcss-installbycdn.html)
			[Tailwind CSS 基础概念](https://www.runoob.com/tailwindcss-basic.html) **
