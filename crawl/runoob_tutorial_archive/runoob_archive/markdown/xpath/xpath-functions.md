...
- Source: https://www.runoob.com/xpath/xpath-functions.html
...
| 存取 错误和跟踪 数值 字符串 | AnyURI 逻辑 持续时间/日期/时间 QName | 节点 序列 Context |
| --- | --- | --- |


![Note](https://www.runoob.com/images/lamp.gif) 函数命名空间的默认前缀为 fn:


![Note](https://www.runoob.com/images/lamp.gif) 函数命名空间的 URI为 : http://www.w3.org/2005/xpath-functions
...
| fn:lang(lang) | 如果当前节点的语言匹配指定的语言，则返回 true。 例子：Lang("en") is true for ... 例子：Lang("de") is false for ... |
...
| 名称 | 说明 |
| --- | --- |
| fn:position() | 返回当前正在被处理的节点的 index 位置。 例子：//book[position() 结果：选择前三个 book 元素 |
