...
- Source: https://www.runoob.com/angularjs/angularjs-model.html
...
```javascript
<div ng-app="myApp" ng-controller="myCtrl">    名字:
...
```javascript
<div ng-app="myApp" ng-controller="myCtrl">    名字:
	<input ng-model="name">    <h1>你输入了: {{name}}</h1>
	</div>
```
...
<form ng-app="" name="myForm">    Email:
	...
	<span ng-show="myForm.myAddress.$error.email">不是一个合法的邮箱地址</span></form>
```
...
- ng-pristine
	  ...
	  AI 思考中...
			...
			** [AngularJS API](https://www.runoob.com/angularjs-api.html)
			[AngularJS Scope(作用域)](https://www.runoob.com/angularjs-scopes.html) **