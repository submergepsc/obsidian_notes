...
- Source: https://www.runoob.com/angularjs/angularjs-scopes.html
...
```javascript
<div ng-app="myApp" ng-controller="myCtrl">
	<h1>{{lastname}} 家族成员:</h1><ul>    <li ng-repeat="x in names">{{x}}
	{{lastname}}</li></ul></div><script>
```
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=try_ng_scope_rootscope)
	  ...
	  AI 思考中...
			...
			** [AngularJS ng-model 指令](https://www.runoob.com/angularjs-model.html)
			[AngularJS ng-app 指令](https://www.runoob.com/ng-ng-app.html) **