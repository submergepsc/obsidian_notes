...
- Source: https://www.runoob.com/angularjs/angularjs-directives.html
...
完整的指令内容可以参阅 [AngularJS 参考手册](https://www.runoob.com/angularjs-reference.html)。
...
<body ng-app="myApp"><runoob-directive></runoob-directive>
	<script>var app = angular.module("myApp", []);app.directive("runoobDirective",
	function() {    return {
