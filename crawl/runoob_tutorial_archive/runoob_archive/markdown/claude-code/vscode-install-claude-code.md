...
- Source: https://www.runoob.com/claude-code/vscode-install-claude-code.html
...
**5、多行输入**：**按 Shift + Enter** 可以换行，不用立刻发送消息。
...
想让 Claude 看懂你的代码？直接用 `**@**` 提到文件或文件夹就行！


输入 `**@**` 后面跟文件名或文件夹名，Claude 就会自动读取内容，可以回答问题或直接修改。
...
点击 Claude Code 面板**顶部**的下拉菜单，就能看到你的所有聊天历史记录。

支持**关键字搜索**，也能按时间筛选（今天、昨天、过去 7 天等）。

点击任意一条记录，就能完整恢复之前的对话内容。


鼠标悬停在某条记录上，会出现 **重命名** 和 **删除** 按钮：
...
![](https://www.runoob.com/wp-content/uploads/2026/03/de8cd93b-fb36-4abc-aca3-ce289227fa90.png)
	  ...
	  AI 思考中...
			...
			** [Claude Code Skills 使用实例](https://www.runoob.com/claude-code-ui-ux-pro-max-skill.html)
