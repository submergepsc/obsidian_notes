...
- Source: https://www.runoob.com/claude-code/claude-code-project.html
...
- `commands/` — 当你发现自己重复输入相同的指令时
- `rules/` — 当 CLAUDE.md 超过 100 行时，拆分模块
- `skills/` — 当有复杂的多步骤工作流需要标准化时
- `agents/` — 当任务复杂到需要多个专业视角并行时
