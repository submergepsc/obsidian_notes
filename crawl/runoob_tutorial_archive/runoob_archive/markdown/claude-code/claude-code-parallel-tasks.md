...
- Source: https://www.runoob.com/claude-code/claude-code-parallel-tasks.html
...
Worktree 创建位置：`/.claude/worktrees/`
...
| 孤立的 tmux 会话 | 使用 tmux ls 和 tmux kill-session -t 清理 |
...
```
	  ...
	  AI 思考中...
			...
			** [Claude Code 权限配置](https://www.runoob.com/claude-code-permission.html)
