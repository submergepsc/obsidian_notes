...
- Source: https://www.runoob.com/claude-code/claude-code-install.html
...
Claude Code 在启动和运行时会**自动检查更新**，后台下载完成后，下次启动即生效。自动更新相关配置写在 `settings.json` 中：
...
**
⚠️ 删除配置文件是不可恢复**的操作，所有本地设置和历史记录将永久丢失，执行前请确认。
...
| exit 或 Ctrl+C | 退出 Claude Code，返回终端 | exit |
	  ...
	  AI 思考中...
			...
			** [Claude Code 简介](https://www.runoob.com/claude-code-intro.html)
