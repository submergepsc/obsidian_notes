...
- Source: https://www.runoob.com/claude-code/claude-code-setup.html
...
| --- | --- | --- |
| DeepSeek（国产高性价比） | 官方模型：deepseek-v4-flash deepseek-v4-pro deepseek-chat (将于 2026/07/24 弃用) deepseek-reasoner (将于 2026/07/24 弃用) | https://platform.deepseek.com/api_keys |
...
- `ANTHROPIC_MODEL`：指定使用 deepseek-v4-pro 模型
...
- ANTHROPIC_BASE_URL：替换为百炼的兼容端点地址 **https://dashscope.aliyuncs.com/apps/anthropic**。 可以直接购买资源包，这样用起来更划算：[https://cn.aliyun.com/benefit?from_alibabacloud=&userCode;=i5mn5r7m](https://cn.aliyun.com/benefit?from_alibabacloud=&userCode=i5mn5r7m)
...
![](https://www.runoob.com/wp-content/uploads/2025/12/98fa9dc0-efab-4afc-a100-350ad114937c.png) AI 思考中... ** [Claude Code 安装与使用](https://www.runoob.com/claude-code-install.html) [Claude Code 第一次使用](https://www.runoob.com/claude-code-first-demo.html) ** ### 点我分享笔记 笔记需要是本篇文章的内容扩展！
**
