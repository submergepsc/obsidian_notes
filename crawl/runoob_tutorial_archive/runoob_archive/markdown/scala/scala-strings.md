...
**[运行实例 »](https://www.runoob.com/try/runcode.php?filename=TestBuf&type=scala)
...
| 46 | static String valueOf(primitive data type x) 返回指定类型参数的字符串表示形式 |
	  ...
	  AI 思考中...
			...
			** [Scala 闭包](https://www.runoob.com/scala-closures.html)
			[Scala 数组](https://www.runoob.com/scala-arrays.html) **
