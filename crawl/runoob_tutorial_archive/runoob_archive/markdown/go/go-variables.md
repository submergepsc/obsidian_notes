...
![](https://www.runoob.com/wp-content/uploads/2015/06/4.4.2_fig4.1.jpg)
...
![](https://www.runoob.com/wp-content/uploads/2015/06/4.4.2_fig4.3.jpg)
...
并行赋值也被用于当一个函数返回多个返回值时，比如这里的 val 和错误 err 是通过调用 Func1 函数同时得到：val, err = Func1(var1)。
	  ...
	  AI 思考中...
			...
			** [Go 语言数据类型](https://www.runoob.com/go-data-types.html)
			[Go 语言常量](https://www.runoob.com/go-constants.html) **