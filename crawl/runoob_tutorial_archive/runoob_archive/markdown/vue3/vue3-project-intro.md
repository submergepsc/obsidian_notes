...
- Source: https://www.runoob.com/vue3/vue3-project-intro.html
...
- **启动开发服务器**： - 运行 `**npm run serve**` 或 `**yarn serve**`，启动开发服务器。 - 打开浏览器访问 `**http://localhost:8080**`，查看应用。
- **构建生产环境代码**： - 运行 `**npm run build**` 或 `**yarn build**`，生成优化后的生产环境代码。
- **代码格式化**： - 运行 `**npm run lint**` 或 `**yarn lint**`，格式化代码。
	  ...
	  AI 思考中...
			...
			** [Vue3 选项式 API](https://www.runoob.com/vue3-options-api.html)
			[Vite 教程](https://www.runoob.com/vite-tutorial.html) **
