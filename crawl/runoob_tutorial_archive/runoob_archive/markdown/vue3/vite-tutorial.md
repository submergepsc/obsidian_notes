...
- Source: https://www.runoob.com/vue3/vite-tutorial.html
...
![](https://www.runoob.com/wp-content/uploads/2025/03/runoob-vite.jpg)
...
- **开发模式：**Vite 启动一个开发服务器，利用浏览器原生支持 ES 模块的特性，直接加载源代码。
...
![](https://www.runoob.com/wp-content/uploads/2025/03/1ef5b7c6-e555-4637-b626-61608f9d0a4d.png)
...
![](https://www.runoob.com/wp-content/uploads/2025/03/5eb52178-9a48-43f2-8219-792211f5fa9d.png)


使用 Vite 创建的项目通常包含以下文件和文件夹：


![](https://www.runoob.com/wp-content/uploads/2025/03/b0eceb3e-32e3-488d-a79e-643819c4d589.png)


- **node_modules:** 存放项目依赖的文件夹。
- **public:** 存放静态资源的文件夹，例如图片、字体等。
- **src:** 存放项目源代码的文件夹。**main.js:** 项目入口文件。
- **App.vue:** Vue 项目根组件。
...
![](https://www.runoob.com/wp-content/uploads/2025/03/d8e67be5-c7a8-46e9-b21c-a9cf24086964.png)
...
![](https://www.runoob.com/wp-content/uploads/2025/03/8470f107-5dcf-4832-8e06-0b6e1d0bf352.png)


你会发现浏览器会自动刷新，并显示修改后的效果。


![](https://www.runoob.com/wp-content/uploads/2025/03/959bf527-e703-4496-a072-7d37c800d58d-1.png)
...
- **启动开发服务器** - 创建一个 HTTP 服务器，默认端口 `5173`。 - 提供热更新（HMR, Hot Module Replacement）能力。 - 将 Vue 文件、JS/TS、CSS 等通过内置的 Vite 插件转换成浏览器可识别的代码。
...
![](https://www.runoob.com/wp-content/uploads/2025/03/mermaid-vite-flow-scaled.png)
...
例如，在 Vue 项目中，你可以使用 **** 来编写 Sass 代码。
...
- **`server`** 开发服务器配置： - `port`：指定开发服务器的端口号。 - `open`：是否在启动开发服务器时自动打开浏览器。 - `proxy`：配置代理服务器，用于解决跨域问题。例如，将 `/api` 开头的请求代理到 `http://localhost:8080`。
- **`build`** 构建配置： - `outDir`：指定构建输出的目录。 - `assetsDir`：指定静态资源（如图片、字体）的存放目录。 - `sourcemap`：是否生成 sourcemap 文件，便于调试。 - `minify`：是否压缩代码，`terser` 是默认的压缩工具。 - `rollupOptions`：配置 Rollup 打包选项，例如外部依赖和代码分割。
...
- **`envPrefix`** 配置环境变量的前缀。默认情况下，Vite 只会加载以 `VITE_` 开头的环境变量。
	  ...
	  AI 思考中...
			...
			** [Vue3 项目说明](https://www.runoob.com/vue3-project-intro.html)
			[vue3 createApp() 函数](https://www.runoob.com/vue3-api-createapp.html) **
