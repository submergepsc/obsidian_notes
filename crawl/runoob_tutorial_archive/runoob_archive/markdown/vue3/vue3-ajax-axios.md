...
- Source: https://www.runoob.com/vue3/vue3-ajax-axios.html
...
如果你想使用 async/await，请在外部函数/方法中添加 async 关键字。
...
**注意：** async/await 是 ECMAScript 2017 的一部分，不支持 Internet Explorer 和旧版浏览器，因此请谨慎使用。
...
[尝试一下 »](https://www.runoob.com/try/try.php?filename=vue3-ajax-axios3)
