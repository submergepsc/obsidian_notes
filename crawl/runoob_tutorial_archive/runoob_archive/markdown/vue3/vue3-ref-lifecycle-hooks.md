...
- Source: https://www.runoob.com/vue3/vue3-ref-lifecycle-hooks.html
...
![](https://www.runoob.com/wp-content/uploads/2024/06/lifecycle_zh-CN.W0MNXI0C.png)
...
**
[尝试一下 »](https://www.runoob.com/try/try.php?filename=vue3-lf-hooks)


这个实例会在控制台打印出每个生命周期钩子函数的日志，帮助理解各个生命周期阶段的顺序和用途。


![](https://www.runoob.com/wp-content/uploads/2024/06/2cdfc5251312e509d7f5de956f166fb6.png)
...
- **`onCreated`** 和 **`onBeforeCreate`** 在组合式 API 中通常不常用，因为 `setup` 中的代码会在创建阶段运行。
...
- **逻辑更清晰**：与 `setup` 内的其他逻辑在一个函数中实现，减少代码分散和复杂度。
	  ...
	  AI 思考中...
			...
			** [Vue 实例选项](https://www.runoob.com/vue-ref-options.html)
			[Vue3 AI 编程助手](https://www.runoob.com/fitten-code-vue3.html) **
