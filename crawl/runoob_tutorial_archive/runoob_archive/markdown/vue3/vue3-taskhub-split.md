...
- Source: https://www.runoob.com/vue3/vue3-taskhub-split.html
...
![](https://www.runoob.com/wp-content/uploads/2026/01/461039b9-7063-486f-931b-523cd6189506.png)
...
- `TaskItem` 通过 `props` 接收任务数据。在 Vue 中，Props 是**只读**的。子组件绝不应该直接修改 `props` 的值，这就是"单向数据流"。
...
- 在 `TaskFilter` 中，我们使用了 Vue 3.4 引入的 `defineModel`。它极大地简化了父子组件之间状态同步的代码，不再需要手动写 `props` 和监听 `[@update](https://github.com/update):modelValue`。
