...
- Source: https://www.runoob.com/tensorflow/tensorflow-setup.html
...
- **下载和安装 CUDA Toolkit** - 访问 [NVIDIA CUDA Toolkit](https://developer.nvidia.com/cuda-toolkit) - 选择对应版本下载安装 - 添加到系统 PATH
- **下载和安装 cuDNN** - 访问 [NVIDIA cuDNN](https://developer.nvidia.com/cudnn) - 需要注册 NVIDIA 账户 - 解压到 CUDA 安装目录
- **验证 CUDA 安装**
```
nvcc --version
nvidia-smi
