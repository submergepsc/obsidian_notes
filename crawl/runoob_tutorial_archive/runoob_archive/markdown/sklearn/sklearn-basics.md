...
- Source: https://www.runoob.com/sklearn/sklearn-basics.html

在使用 Sklearn 进行机器学习时，需要了解一些基础的概念。

Sklearn 提供了一种统一且简洁的 API 来实现各种机器学习算法和流程，能够帮助我们快速实现各种机器学习任务。

接下来我们从以下几个概念展开说明：**数据表示、模型类型、预处理方法、评估指标、模型调优**等。
...
**网格搜索**是一种常用的超参数调优方法，它通过遍历所有可能的参数组合来寻找最佳的超参数组合。
...
**随机搜索**是一种通过随机选择超参数的组合来搜索最优超参数的方法，它比网格搜索效率高。
