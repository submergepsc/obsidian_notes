...
- Source: https://www.runoob.com/sklearn/sklearn-data-preprocessing.html
...
更多内容可以参考：[Pandas 数据清洗](https://www.runoob.com/../pandas/pandas-cleaning.html)
...
使用一些机器学习模型（如**决策树**或**随机森林**）来评估特征的重要性，从而进行特征选择。
...
```
	  ...
	  AI 思考中...
			...
			** [Sklearn 基础概念](https://www.runoob.com/sklearn-basics.html)
			[Sklearn 机器学习模型](https://www.runoob.com/sklearn-ml-model.html) **
