...
- Source: https://www.runoob.com/sklearn/sklearn-ml-model.html
...
逻辑回归虽然名字中带"回归"，但本质是**概率型分类模型**，常用于二分类问题。
...
![](https://www.runoob.com/wp-content/uploads/2024/12/e1620c9c-e997-4293-9384-f481fdb9f0af.png)
...
![](https://www.runoob.com/wp-content/uploads/2024/12/1a55a144-d755-427a-a4f7-b7518850aeda.png)
...
模型性能往往受到超参数设置影响较大。**网格搜索通过遍历参数组合，自动寻找最优配置。
...
```
	  ...
	  AI 思考中...
			...
			** [Sklearn 数据预处理](https://www.runoob.com/sklearn-data-preprocessing.html)
			[Sklearn 模型评估与调优](https://www.runoob.com/sklearn-model-evaluation.html) **
