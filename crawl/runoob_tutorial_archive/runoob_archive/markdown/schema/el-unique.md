...
- Source: https://www.runoob.com/schema/el-unique.html
...
- oselector 元素包含 XPath 表达式，指定一个元素集，在其中由 field 元素指定的值必须唯一。必须有一个且只有一个 selector 元素。
...
[![XML Schema 参考手册](https://www.runoob.com/images/up.gif) 完整 XML Schema 参考手册](https://www.runoob.com/schema-elements-ref.html)
	  ...
	  AI 思考中...
			...
			** [XML Schema union 元素](https://www.runoob.com/el-union.html)
			[XML Schema all 元素](https://www.runoob.com/el-all.html) **
