...
- Source: https://www.runoob.com/fastapi/fastapi-error-handling.html
...
**
注意这里使用的是 `raise` 而不是 `return`。`HTTPException` 是一个异常，抛出后 FastAPI 会捕获它并返回对应的 HTTP 错误响应。这与 Python 的异常处理机制一致。
...
- 使用 `RedirectResponse` 实现重定向
	  ...
	  AI 思考中...
			...
			** [FastAPI 请求头与 Cookie](https://www.runoob.com/fastapi-header-cookie.html)
