...
- Source: https://www.runoob.com/fastapi/fastapi-path-operation-dependencies.html
...
- 请求到达时，执行 `yield` 之前的代码，创建数据库连接
- `yield` 将连接传递给路由函数
- 路由函数执行完毕后，执行 `finally` 块中的清理代码
...
- 全局依赖对所有路由生效
	  ...
	  AI 思考中...
			...
			** [FastAPI 请求和响应](https://www.runoob.com/fastapi-request-response.html)
			[FastAPI 表单数据](https://www.runoob.com/fastapi-form.html) **
