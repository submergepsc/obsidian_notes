...
Java Iterator（迭代器）不是一个集合，它是一种用于访问集合的方法，可用于迭代 [ArrayList](https://www.runoob.com/java-arraylist.html) 和 [HashSet](https://www.runoob.com/java-hashset.html) 等集合。
...
[![Java 集合框架](https://www.runoob.com/images/up.gif) Java 集合框架](https://www.runoob.com/java-collections.html)
	  ...
	  AI 思考中...
			...
			** [Java HashSet](https://www.runoob.com/java-hashset.html)
			[Java ArrayList add() 方法](https://www.runoob.com/java-arraylist-add.html) **
