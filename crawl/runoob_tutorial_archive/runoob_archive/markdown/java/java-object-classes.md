...
- 示例： 方法重载：`public int add(int a, int b) { ... }` 和 `public double add(double a, double b) { ... }`
...
- 示例： 抽象类：`public abstract class Shape { abstract void draw(); }`
...
除了上面提到的几种类型，Java 还有一些特殊的类，如：[内部类](https://www.runoob.com/java-inner-class.html)、[匿名类](https://www.runoob.com/java-anonymous-class.html)。
...
```
	  ...
	  AI 思考中...
			...
			** [Java 基础语法](https://www.runoob.com/java-basic-syntax.html)
			[Java 基本数据类型](https://www.runoob.com/java-basic-datatypes.html) **