...
- Source: https://www.runoob.com/java/collection-enumeration.html
...
[![Java 实例](https://www.runoob.com/images/up.gif) Java 实例](https://www.runoob.com/java-examples.html)
	  ...
	  AI 思考中...
			...
			** [Java 实例 – 集合中添加不同类型元素](https://www.runoob.com/collection-all.html)
			[Java 实例 – 遍历 HashTable 的键值](https://www.runoob.com/collection-hashtable-key.html) **
