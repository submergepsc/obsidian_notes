...
JDK 5 后的版本我们也可以使用 [Java Scanner](https://www.runoob.com/java-scanner-class.html) 类来获取控制台的输入。
...
- [ByteArrayInputStream](https://www.runoob.com/java-bytearrayinputstream.html)
- [DataInputStream](https://www.runoob.com/java-datainputstream.html)
...
- [ByteArrayOutputStream](https://www.runoob.com/java-bytearrayoutputstream.html)
- [DataOutputStream](https://www.runoob.com/java-dataoutputstream.html)
...
- [File Class(类)](https://www.runoob.com/java-file.html)
- [FileReader Class(类)](https://www.runoob.com/java-filereader.html)
- [FileWriter Class(类)](https://www.runoob.com/java-filewriter.html)
...
```
	  ...
	  AI 思考中...
			...
			** [Java 方法](https://www.runoob.com/java-methods.html)
			[Java 异常处理](https://www.runoob.com/java-exceptions.html) **