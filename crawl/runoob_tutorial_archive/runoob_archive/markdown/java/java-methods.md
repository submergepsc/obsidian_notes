...
**
更多内容参考下一章节：[Java 构造方法](https://www.runoob.com/java-constructor.html)。
...
> finalize 方法在 Java 9 中已被标记为废弃，并在未来的 Java 版本中将会移除。推荐使用 **[try-with-resources](https://www.runoob.com/java9-try-with-resources-improvement.html)** 或 **[java.lang.ref.Cleaner](https://www.runoob.com/java-cleaner-class.html)** 来管理资源。
...
```
	  ...
	  AI 思考中...
			...
			** [Java 正则表达式](https://www.runoob.com/java-regular-expressions.html)
			[Java 流(Stream)、文件(File)和IO](https://www.runoob.com/java-files-io.html) **