...
前两种注释内容可以参考：[Java 注释](https://www.runoob.com/java-comments.html)
...
```
	  ...
	  AI 思考中...
			...
			** [Java Applet 基础](https://www.runoob.com/java-applet-basics.html)
			[Java 实例 – 如何编译 Java 文件](https://www.runoob.com/env-compile.html) **