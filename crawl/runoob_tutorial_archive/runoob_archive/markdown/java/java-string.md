...
如果需要对字符串做很多修改，那么应该选择使用 [StringBuffer & StringBuilder 类](https://www.runoob.com/java-stringbuffer.html)。
...
| 48 | isEmpty() 判断字符串是否为空。 |
	  ...
	  AI 思考中...
			...
			** [Java Character 类](https://www.runoob.com/java-character.html)
			[Java StringBuffer 和 StringBuilder 类](https://www.runoob.com/java-stringbuffer.html) **