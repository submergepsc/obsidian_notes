...
更多内容可以参考：[Java 注释](https://www.runoob.com/java-comments.html)。
...
下一节介绍 Java 编程中的类和对象。之后你将会对 Java 中的类和对象有更清楚的认识。
	  ...
	  AI 思考中...
			...
			** [Java 开发环境配置](https://www.runoob.com/java-environment-setup.html)
			[Java 对象和类](https://www.runoob.com/java-object-classes.html) **