...
- Source: https://www.runoob.com/memcached/memcached-install.html
...
```
	  ...
	  AI 思考中...
			...
			** [Memcached 教程](https://www.runoob.com/memcached-tutorial.html)
			[Memcached 连接](https://www.runoob.com/memcached-connection.html) **