...
- Source: https://www.runoob.com/cplusplus/cpp-date-time.html
...
```
 其中： Www：星期（如 Tue） Mmm：月份（如 Jul） dd：日（如 29） hh:mm:ss：时间（24 小时制） yyyy：年份（如 2025） 最后包含换行符 \n 和结束符 \0 示例返回值：
```
...
```
	  ...
	  AI 思考中...
			...
			** [C++ 引用](https://www.runoob.com/cpp-references.html)
