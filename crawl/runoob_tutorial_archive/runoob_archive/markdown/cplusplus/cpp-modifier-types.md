...
- Source: https://www.runoob.com/cplusplus/cpp-modifier-types.html
...
- 保留为关键字（可能用于兼容或未来用途）
	  ...
	  AI 思考中...
			...
			** [C++ 常量](https://www.runoob.com/cpp-constants-literals.html)
			[C++ 存储类](https://www.runoob.com/cpp-storage-classes.html) **