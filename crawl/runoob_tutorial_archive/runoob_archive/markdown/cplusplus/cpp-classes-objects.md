...
- Source: https://www.runoob.com/cplusplus/cpp-classes-objects.html
...
| C++ 类的静态成员 | 类的数据成员和函数成员都可以被声明为静态的。 |
	  ...
	  AI 思考中...
			...
			** [C++ 把引用作为返回值](https://www.runoob.com/returning-values-by-reference.html)
			[C++ 继承](https://www.runoob.com/cpp-inheritance.html) **