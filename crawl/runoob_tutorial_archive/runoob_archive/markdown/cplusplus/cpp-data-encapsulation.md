...
- Source: https://www.runoob.com/cplusplus/cpp-data-encapsulation.html
...
- **实现抽象**: 提供了一种机制，使得用户不需要了解类的内部实现细节，只需要了解如何使用类的公共接口即可。
	  ...
	  AI 思考中...
			...
			** [C++ 数据抽象](https://www.runoob.com/cpp-data-abstraction.html)
			[C++ 接口（抽象类）](https://www.runoob.com/cpp-interfaces.html) **