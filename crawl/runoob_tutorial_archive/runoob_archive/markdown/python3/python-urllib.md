...
如果要将抓取的网页保存到本地，可以使用 [Python3 File write() 方法](https://www.runoob.com/python3-file-write.html) 函数：
...
更多Python File 处理，可以参阅：[https://www.runoob.com/python3/python3-file-methods.html](https://www.runoob.com/python3-file-methods.html)
。
...
--- ## urllib.parse urllib.parse 用于解析 URL，格式如下：
...
```
	  ...
	  AI 思考中...
			...
			** [Python3 map() 函数](https://www.runoob.com/python3-func-map.html)
			[Python3 pip](https://www.runoob.com/python3-pip.html) **
