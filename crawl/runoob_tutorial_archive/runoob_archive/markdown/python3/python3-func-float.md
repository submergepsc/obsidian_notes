...
- Source: https://www.runoob.com/python3/python3-func-float.html
...
- 可以使用 `math.isinf()` 和 `math.isnan()` 来检测这些特殊值。
...
---
	  ...
	  AI 思考中...
			...
			** [Python int() 函数](https://www.runoob.com/python3-func-int.html)
