...
- Source: https://www.runoob.com/python3/python-remove-duplicate-from-list.html
...
- [Python 集合](https://www.runoob.com/python3-set.html)：集合（set）是一个无序的不重复元素序列。
- [Python 列表](https://www.runoob.com/python3-list.html)：列表是一种数据项构成的有限序列，即按照一定的线性顺序排列而成的数据项的集合，在这种数据结构上进行的基本操作包括对元素的的查找、插入和删除。
