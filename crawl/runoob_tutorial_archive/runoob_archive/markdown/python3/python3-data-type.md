...
**{x: x**2 for x in (2, 4, 6)}** 使用的是字典推导式，更多推导式内容可以参考：[Python 推导式](https://www.runoob.com/python-comprehensions.html)。
...
有时候我们需要对数据内置的类型进行转换，只需要将数据类型作为函数名即可。在下一章节 [Python3 数据类型转换](https://www.runoob.com/python3-type-conversion.html) 会具体介绍。
...
| oct(x) | 将一个整数转换为八进制字符串 |
	  ...
	  AI 思考中...
			...
			** [Python3 基础语法](https://www.runoob.com/python3-basic-syntax.html)
			[Python3 实例](https://www.runoob.com/python3-examples.html) **