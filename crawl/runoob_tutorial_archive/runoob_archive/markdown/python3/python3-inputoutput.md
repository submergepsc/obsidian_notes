...
Python 提供了 [input() 内置函数](https://www.runoob.com/python3-func-input.html)从标准输入读入一行文本，默认的标准输入是键盘。
...
```
	  ...
	  AI 思考中...
			...
			** [Python3 模块](https://www.runoob.com/python3-module.html)
			[Python3 错误和异常](https://www.runoob.com/python3-errors-execptions.html) **