...
| SMTPHandler | 通过邮件发送日志 | handler = logging.SMTPHandler("mail.example.com", "[email protected]", "[email protected]", "Error Log") |
...
```
	  ...
	  AI 思考中...
			...
			** [Python csv 模块](https://www.runoob.com/python-csv.html)
			[Python threading 模块](https://www.runoob.com/python-treading.html) **
