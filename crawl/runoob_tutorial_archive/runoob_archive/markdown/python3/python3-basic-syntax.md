...
**
更多 Python 保留关键字参考：[https://www.runoob.com/python3/python3-keyword.html](https://www.runoob.com/python3-keyword.html)。
...
我们在使用脚本形式执行 Python 时，可以接收命令行输入的参数，具体使用可以参照 [Python 3 命令行参数](https://www.runoob.com/python3-command-line-arguments.html)。
...
开始测验
	  ...
	  AI 思考中...
			...
			** [Python3 标准库概览](https://www.runoob.com/python3-stdlib.html)
			[Python3 基本数据类型](https://www.runoob.com/python3-data-type.html) **