...
更多 with 关键字内容参考：[Python with 关键字](https://www.runoob.com/python-with.html)
...
[Python assert（断言）](https://www.runoob.com/python3-assert.html)


[Python with 关键字](https://www.runoob.com/python-with.html)
	  ...
	  AI 思考中...
			...
			** [Python3 输入和输出](https://www.runoob.com/python3-inputoutput.html)
			[Python3 面向对象](https://www.runoob.com/python3-class.html) **