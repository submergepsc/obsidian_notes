...
**
openai 开源地址：[https://github.com/openai/openai-python](https://github.com/openai/openai-python)
...
| model | 必填，要设置的模型： deepseek-chat：对应 DeepSeek 的非思考模式，响应速度快，适合常规问答。 deepseek-reasoner：对应 DeepSeek 的思考模式，推理能力更强，适合复杂问题求解。 |
...
也可以直接使用百炼的 Coding Plan 套餐：[https://www.aliyun.com/benefit/scene/codingplan](https://www.aliyun.com/benefit/scene/codingplan?source=5176.29345612&userCode=i5mn5r7m)。
...
更多 API 参考：[https://github.com/openai/openai-python/blob/main/api.md](https://github.com/openai/openai-python/blob/main/api.md)
	  ...
	  AI 思考中...
			...
			** [uv 入门教程 — Python 包与环境管理工具](https://www.runoob.com/uv-tutorial.html)
