...
- Source: https://www.runoob.com/python3/python3-att-dictionary-values.html
...
[dict.keys()](https://www.runoob.com/python3-att-dictionary-keys.html)、dict.values() 和 [dict.items()](https://www.runoob.com/python3-att-dictionary-items.html) 返回的都是视图对象（ view objects），提供了字典实体的动态视图，这就意味着字典改变，视图也会跟着变化。
...
[![Python3 字典](https://www.runoob.com/images/up.gif) Python3 字典](https://www.runoob.com/python3-dictionary.html)
	  ...
	  AI 思考中...
			...
			** [Python3 字典 update() 方法](https://www.runoob.com/python3-att-dictionary-update.html)
			[Python3 File 方法](https://www.runoob.com/python3-file-methods.html) **