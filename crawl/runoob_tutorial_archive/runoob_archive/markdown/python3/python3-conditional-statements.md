...
match subject case  ? 匹配 action_1 不匹配 case  ? 匹配 action_2 不匹配 case  ? 匹配 action_3 不匹配 case _（通配符） 必匹配 wildcard 语法格式如下：
...
status 401 403 404 | | "Not allowed" ## 实例
```python
...
```
 **match...case** 更多内容参考：[Python match-case 语句](https://www.runoob.com/python-match-case.html)
	  ...
	  AI 思考中...
			...
			** [Python3 编程第一步](https://www.runoob.com/python3-step1.html)
			[Python3 循环语句](https://www.runoob.com/python3-loop.html) **