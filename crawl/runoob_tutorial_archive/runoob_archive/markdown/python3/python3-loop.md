...
更多关于 range() 函数用法参考：[https://www.runoob.com/python3/python3-func-range.html](https://www.runoob.com/python3-func-range.html)
...
![](https://www.runoob.com/wp-content/uploads/2014/09/8962A4F1-B78C-4877-B328-903366EA1470.jpg) while 语句代码执行过程：
...
以下实例循环字符串 Runoob，碰到字母 o 跳过输出： ## 实例
```python
#!/usr/bin/python3
...
```
	  ...
	  AI 思考中...
			...
			** [Python3 条件控制](https://www.runoob.com/python3-conditional-statements.html)
			[Python3 函数](https://www.runoob.com/python3-function.html) **