...
- Source: https://www.runoob.com/python3/python3-func-tuple.html
...
- **参数 iterable**： 类型： 可迭代对象（列表、字符串、字典、集合等）
- 描述： 要转换为元组的可迭代对象。
...
---
	  ...
	  AI 思考中...
			...
			** [Python3 bytes 函数](https://www.runoob.com/python3-func-bytes.html)
			[Python3 reversed 函数](https://www.runoob.com/python3-func-reversed.html) **