...
- Source: https://www.runoob.com/python3/fitten-code.html
...
### 1、安装 点击左上方"文件"再点击"设置"，如下图所示 接着点击左侧"插件"选择"Marketplace"，并搜索"Fitten Code"，然后点击"安装"进行安装 安装完成后左侧会出现 Fitten Code 插件图标,注册登录后即可开始使用 2、智能补全
...
- VS Code
- [JetBrains IDE 系列（包括 PyCharm）](https://code.fittentech.com/tutor_jetbrains_zh#1)：本文会详细介绍
...
在使用该功能时，只需要输入需要完成的开发任务，例如"将此函数拆分成多个 python 文件并放入当前文件夹下"、"修改此对象，将其封装为类"**等，智能体就可以根据任务调用不同工具逐步完成开发任务。
...
- [Vim](https://code.fittentech.com/tutor_vim_zh#1)
	  ...
	  AI 思考中...
			...
			* [Python OpenAI](https://www.runoob.com/python-openai.html)
			[Python re.search() 方法](https://www.runoob.com/python-re-search.html) **
