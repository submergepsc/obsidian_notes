...
在 PowerShell 中，多个命令通过 `|` 连接时，传递的是**对象**而非文本。**这意味着你可以在后续命令中直接访问前一个命令传递的对象属性。
...
![](https://www.runoob.com/wp-content/uploads/2025/07/5fbc3faf-b524-4df3-bd25-bc91858b618f.png)
...
- 尝试将命令结果导出为 CSV 或 JSON 文件
	  ...
	  AI 思考中...
			...
			** [PowerShell 入门指南](https://www.runoob.com/powershell-start.html)
