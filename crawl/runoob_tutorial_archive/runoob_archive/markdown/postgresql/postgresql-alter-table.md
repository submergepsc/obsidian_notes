...
- Source: https://www.runoob.com/postgresql/postgresql-alter-table.html
...
```
	  ...
	  AI 思考中...
			...
			** [PostgreSQL 索引](https://www.runoob.com/postgresql-index.html)
			[PostgreSQL TRUNCATE TABLE](https://www.runoob.com/postgresql-truncate-table.html) **