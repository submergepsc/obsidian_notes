...
- Source: https://www.runoob.com/xsl/el-text.html
...
| 属性 | 值 | 描述 |
| --- | --- | --- |
| disable-output-escaping | yesno | 可选。如果值为 "yes"，通过实例化 元素生成的文本节点在输出时将不进行任何转义。比如 "Netscape 6 不支持该属性。 |
