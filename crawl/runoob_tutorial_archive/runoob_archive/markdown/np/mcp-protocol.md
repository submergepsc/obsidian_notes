...
- Source: https://www.runoob.com/np/mcp-protocol.html
...
![](https://www.runoob.com/wp-content/uploads/2025/03/model-context-protocol-architecture.webp)


![](https://www.runoob.com/wp-content/uploads/2025/03/21c8e096-6645-469a-b537-3591c1abb483_944x733.jpg)
...
![](https://www.runoob.com/wp-content/uploads/2025/03/https___dev-to-uploads.s3.amazonaws.com_uploads_articles_nuvybev34xhz3btc0xys.jpeg)
...
![](https://www.runoob.com/wp-content/uploads/2025/03/mcp-n-1.png)
...
![](https://www.runoob.com/wp-content/uploads/2025/03/mcp-n-2.png)
...
![](https://www.runoob.com/wp-content/uploads/2025/03/mcp-n-3.png)
...
- **`error`**：如果请求失败，`error`字段包含错误信息，其中：**`code`**：错误代码，是一个数字。
- **`message`**：错误描述，是一个字符串。
...
- **请求和响应**：请求和响应是一对一的，客户端发送请求后，服务器会返回一个响应。`id`字段用于关联请求和响应。
- **通知**：通知是单向的，发送方不需要等待接收方的回复。通知通常用于事件推送或状态更新等场景。
- **错误处理**：如果请求失败，响应中会包含`error`字段，提供错误代码和描述，帮助开发者快速定位问题。
