...
- Source: https://www.runoob.com/mongodb/mongodb-operators.html
...
```
	  ...
	  AI 思考中...
			...
			** [MongoDB 查询文档](https://www.runoob.com/mongodb-query.html)
			[MongoDB $type 操作符](https://www.runoob.com/mongodb-operators-type.html) **