...
- Source: https://www.runoob.com/mongodb/mongodb-query.html
...
| 小于 | {:{$lt:}} | db.col.find({"likes":{$lt:50}}).pretty() | where likes |
| 小于或等于 | {:{$lte:}} | db.col.find({"likes":{$lte:50}}).pretty() | where likes |
...
```
	  ...
	  AI 思考中...
			...
			** [MongoDB 删除文档](https://www.runoob.com/mongodb-remove.html)
