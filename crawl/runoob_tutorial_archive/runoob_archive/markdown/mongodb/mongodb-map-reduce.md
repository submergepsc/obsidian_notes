...
- Source: https://www.runoob.com/mongodb/mongodb-map-reduce.html
...
![](https://static.runoob.com/images/map-reduce.bakedsvg.svg)
...
Map函数和Reduce函数可以使用 JavaScript 来实现，使得MapReduce的使用非常灵活和强大。
	  ...
	  AI 思考中...
			...
			** [MongoDB ObjectId](https://www.runoob.com/mongodb-objectid.html)
			[MongoDB 全文检索](https://www.runoob.com/mongodb-text-search.html) **