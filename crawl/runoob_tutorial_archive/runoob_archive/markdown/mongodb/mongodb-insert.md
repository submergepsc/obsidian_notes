...
- Source: https://www.runoob.com/mongodb/mongodb-insert.html
...
```
db.users.insert({ name: "David", age: 40, email: "[email protected]" });
```
...
```
db.users.insert([
  { name: "Eve", age: 45, email: "[email protected]" },
  { name: "Frank", age: 50, email: "[email protected]" }
]);
```
...
```
	  ...
	  AI 思考中...
			...
			** [MongoDB PHP 扩展](https://www.runoob.com/mongodb-install-php-driver.html)
			[MongoDB 更新文档](https://www.runoob.com/mongodb-update.html) **