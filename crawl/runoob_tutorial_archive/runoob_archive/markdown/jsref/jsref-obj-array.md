...
- Source: https://www.runoob.com/jsref/jsref-obj-array.html
...
| [Symbol.iterator]() | 返回一个数组迭代器对象，该对象会产生数组中每个索引的值。 |
	  ...
	  AI 思考中...
			...
			** [JavaScript concat() 方法](https://www.runoob.com/jsref-concat-array.html)
			[JavaScript Boolean constructor 属性](https://www.runoob.com/jsref-constructor-boolean.html) **
