...
# Mouse Side Buttons Tool Lookup

## Current Snapshot

- status: 已完成
- goal: 查找并修复导致鼠标侧键无法前进后退的映射问题。
- blocker: 无
- next: 用户在浏览器中按 G304 两个侧键，确认后退/前进是否恢复。
- updated: 2026-05-15 19:05:00 +0800
...
## Locate Mouse Button Mapping Tools

- updated: 2026-05-15 18:58:00 +0800
- cwd: `/home/loviya`
- source instruction: `我现在的鼠标已经无法完成4,5按键的前进和后退了,我记得安装了一个工具,你查找一下`
- problem:
...
## Restore G304 Side Buttons To Browser Back Forward

- updated: 2026-05-15 19:05:00 +0800
- cwd: `/home/loviya`
- source instruction: `你觉得应该修改哪个,自己决定`
- problem:
