...
# Sub2API Project Lookup

## Current Snapshot

- status: 待继续
- goal: 继续调试本地 `sub2api` 的账号授权与 API 调用状态。
- blocker: OpenAI 账号授权需要用户在浏览器完成 OAuth 后把 callback URL 或 code 填回页面；Gemini key 调用仍需要先给用户余额或 API key quota 充值。
- next: 用户完成 OpenAI OAuth 后，确认新账号写入 `accounts` 表；若要测 Gemini key，先把用户余额或 key quota 从 0 调高再重测。
- updated: 2026-05-15 20:33:21 +0800
...
## Locate Local Sub2API Project

- updated: 2026-05-15 19:12:00 +0800
- cwd: `/home/loviya`
- source instruction: `我记得本地有个sub2api项目,找一下`
- problem:
...
## Diagnose Previous Registration Cannot Be Used

- updated: 2026-05-15 19:24:00 +0800
- cwd: `/home/loviya/sub2api/deploy`
- source instruction: `为什么我之前注册的现在没法使用了`
- problem:
...
## Explain Why Stored Login Password Can Differ

- updated: 2026-05-15 19:31:00 +0800
- cwd: `/home/loviya/sub2api/deploy`
- source instruction: `我之前登陆sub2api的邮箱密码显示错误怎么会是`
- problem:
...
- updated: 2026-05-15 19:38:00 +0800
- cwd: `/home/loviya/sub2api/deploy`
- source instruction: `ok,改成buxinren123`
- problem:
...
## Test Generated Gemini API Key

- updated: 2026-05-15 19:27:39 +0800
- cwd: `/home/loviya/sub2api/deploy`
- source instruction: `sk-...这是我用sub2api生成的密匙,测试一下,gemini账号使用的`
- problem:
...
## Continue Sub2API Authorization Debugging

- updated: 2026-05-15 20:33:21 +0800
- cwd: `/home/loviya/sub2api/deploy`
- source instruction: `继续sub2api调试`
- problem:
